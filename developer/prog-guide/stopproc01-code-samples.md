...
Aqui está o exemplo de código para o cmdlet de exemplo StopProc01. Esse é o `Stop-Process` cmdlet de exemplo descrito em [criando um Cmdlet que modifica o sistema](../cmdlet/creating-a-cmdlet-that-modifies-the-system.md). O `Stop-Process` cmdlet é projetado para interromper os processos que são recuperados usando o cmdlet Get-Proc (descrito na [criando seu primeiro Cmdlet](../cmdlet/creating-a-cmdlet-without-parameters.md)).
...
|Language|Tópico|
|--------------|-----------|
|C#|[StopProc01 (C#) código de exemplo](./stopproc01-csharp-sample-code.md)|
