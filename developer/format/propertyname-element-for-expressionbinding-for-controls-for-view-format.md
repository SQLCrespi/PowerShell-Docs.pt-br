...
Especifica a propriedade .NET cujo valor é exibido pelo controle. Esse elemento é usado durante a definição de controles que podem ser usados por um modo de exibição.
