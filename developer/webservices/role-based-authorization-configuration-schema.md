...
O exemplo [PswsRoleBasedPlugins](https://go.microsoft.com/fwlink/?LinkId=243041) usa arquivos XML para configurar a política de autorização. O XSD a seguir define o esquema usado para esses arquivos.
