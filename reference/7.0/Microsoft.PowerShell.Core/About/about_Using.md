...
> [!NOTE]
> Quando o caminho relativo contém uma barra ( `/` ), o PowerShell trata o caminho como relativo ao local atual, em vez de ser relativo ao local do script. Esse bug é corrigido no PowerShell 7,1.
