...
Os manifestos de módulo, que usam o modo RestrictedLanguage, também permitem as seguintes variáveis adicionais:

- `$PSScriptRoot`
- `$PSEdition` (no PowerShell Core)
- `$EnabledExperimentalFeatures` (no PowerShell Core)
