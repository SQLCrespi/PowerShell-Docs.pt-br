...
Você também pode usar uma configuração de Política de Grupo, ativar o registro em log de módulo para habilitar o log de módulo em todas as sessões do PowerShell. Para obter mais informações, consulte os artigos sobre registro em log e política de grupo.
