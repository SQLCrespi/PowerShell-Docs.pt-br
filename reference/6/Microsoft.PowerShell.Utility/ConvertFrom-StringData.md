...
### Exemplo 2: converter uma cadeia de caracteres aqui contendo um comentário
...
### Exemplo 3: converter uma cadeia de caracteres em uma tabela de hash
...
### Exemplo 4: usar ConvertFrom-StringData na seção de dados de um script
...
### Exemplo 5: usar o operador de pipeline para passar uma cadeia de caracteres
...
### Exemplo 6: usar caracteres de escape para adicionar novas linhas e caracteres de retorno
...
### Exemplo 7: usar o caractere de escape de barra invertida para renderizar corretamente um caminho de arquivo
