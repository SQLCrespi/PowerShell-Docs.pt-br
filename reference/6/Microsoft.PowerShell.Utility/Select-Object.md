...
Especifica as propriedades que esse cmdlet exclui da operação. Caracteres curinga são permitidos.

A partir do PowerShell 6, não é mais necessário incluir o parâmetro **Property** para que o **ExcludeProperty** funcione.
