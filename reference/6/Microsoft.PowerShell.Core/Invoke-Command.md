...
### <span data-ttu-id="11fa4-109">Session</span><span class="sxs-lookup"><span data-stu-id="11fa4-109">Session</span></span>
...
### <span data-ttu-id="11fa4-119">ContainerId</span><span class="sxs-lookup"><span data-stu-id="11fa4-119">ContainerId</span></span>
...
## <span data-ttu-id="11fa4-141">EXEMPLOS</span><span class="sxs-lookup"><span data-stu-id="11fa4-141">EXAMPLES</span></span>
...
### <span data-ttu-id="11fa4-153">Exemplo 3: executar um comando em uma conexão persistente</span><span class="sxs-lookup"><span data-stu-id="11fa4-153">Example 3: Run a command in a persistent connection</span></span>
...
### <span data-ttu-id="11fa4-207">Exemplo 9: incluir variáveis locais em um comando executado em um computador remoto</span><span class="sxs-lookup"><span data-stu-id="11fa4-207">Example 9: Include local variables in a command run on a remote computer</span></span>
...
<span data-ttu-id="11fa4-236">`Invoke-Command` usa um parâmetro **scriptblock** e `Get-ChildItem` especifica os `$args[0]` valores de `$args[1]` matriz e.</span><span class="sxs-lookup"><span data-stu-id="11fa4-236">`Invoke-Command` uses a **ScriptBlock** parameter and `Get-ChildItem` specifies the `$args[0]` and `$args[1]` array values.</span></span> <span data-ttu-id="11fa4-237">O **argumentolist** passa os `$args` valores de matriz para as `Get-ChildItem` posições de parâmetro para **caminho** e **filtro** .</span><span class="sxs-lookup"><span data-stu-id="11fa4-237">The **ArgumentList** passes the `$args` array values to the `Get-ChildItem` parameter positions for **Path** and **Filter** .</span></span>
...
### <span data-ttu-id="11fa4-270">Exemplo 17: acessar um compartilhamento de rede em uma sessão remota</span><span class="sxs-lookup"><span data-stu-id="11fa4-270">Example 17: Access a network share in a remote session</span></span>
...
<span data-ttu-id="11fa4-280">`New-PSSession` Cria um objeto **PSSession** para Server02 e armazena o objeto na `$s` variável.</span><span class="sxs-lookup"><span data-stu-id="11fa4-280">`New-PSSession` creates a **PSSession** object for Server02 and stores the object in the `$s` variable.</span></span>
...
### <span data-ttu-id="11fa4-327">-ArgumentList</span><span class="sxs-lookup"><span data-stu-id="11fa4-327">-ArgumentList</span></span>
...
### <span data-ttu-id="11fa4-339">-AsJob</span><span class="sxs-lookup"><span data-stu-id="11fa4-339">-AsJob</span></span>
...
### <span data-ttu-id="11fa4-350">-Autenticação</span><span class="sxs-lookup"><span data-stu-id="11fa4-350">-Authentication</span></span>
...
<span data-ttu-id="11fa4-385">Especifica a configuração de sessão que é usada para a nova **PSSession** .</span><span class="sxs-lookup"><span data-stu-id="11fa4-385">Specifies the session configuration that is used for the new **PSSession** .</span></span>
...
<span data-ttu-id="11fa4-396">Especifica um URI (Uniform Resource Identifier) que define o ponto de extremidade de conexão da sessão.</span><span class="sxs-lookup"><span data-stu-id="11fa4-396">Specifies a Uniform Resource Identifier (URI) that defines the connection endpoint of the session.</span></span>
...
<span data-ttu-id="11fa4-406">Especifica uma matriz de IDs de contêiner.</span><span class="sxs-lookup"><span data-stu-id="11fa4-406">Specifies an array of container IDs.</span></span>
...
<span data-ttu-id="11fa4-408">Especifica uma conta de usuário que tem permissão para executar esta ação.</span><span class="sxs-lookup"><span data-stu-id="11fa4-408">Specifies a user account that has permission to perform this action.</span></span> <span data-ttu-id="11fa4-409">O padrão é o usuário atual.</span><span class="sxs-lookup"><span data-stu-id="11fa4-409">The default is the current user.</span></span>

<span data-ttu-id="11fa4-410">Digite um nome de usuário, como **User01** ou **Domínio01 \ Usuário01** , ou insira um objeto **PSCredential** gerado pelo `Get-Credential` cmdlet.</span><span class="sxs-lookup"><span data-stu-id="11fa4-410">Type a user name, such as **User01** or **Domain01\User01** , or enter a **PSCredential** object generated by the `Get-Credential` cmdlet.</span></span> <span data-ttu-id="11fa4-411">Se você digitar um nome de usuário, você será solicitado a inserir a senha.</span><span class="sxs-lookup"><span data-stu-id="11fa4-411">If you type a user name, you're prompted to enter the password.</span></span>

<span data-ttu-id="11fa4-412">As credenciais são armazenadas em um objeto [PSCredential](/dotnet/api/system.management.automation.pscredential) e a senha é armazenada como uma [SecureString](/dotnet/api/system.security.securestring).</span><span class="sxs-lookup"><span data-stu-id="11fa4-412">Credentials are stored in a [PSCredential](/dotnet/api/system.management.automation.pscredential) object and the password is stored as a [SecureString](/dotnet/api/system.security.securestring).</span></span>

> [!NOTE]
> <span data-ttu-id="11fa4-413">Para obter mais informações sobre a proteção de dados **SecureString** , consulte [quão seguro é a SecureString?](/dotnet/api/system.security.securestring#how-secure-is-securestring).</span><span class="sxs-lookup"><span data-stu-id="11fa4-413">For more information about **SecureString** data protection, see [How secure is SecureString?](/dotnet/api/system.security.securestring#how-secure-is-securestring).</span></span>
...
### <span data-ttu-id="11fa4-414">-EnableNetworkAccess</span><span class="sxs-lookup"><span data-stu-id="11fa4-414">-EnableNetworkAccess</span></span>

<span data-ttu-id="11fa4-415">Indica que esse cmdlet adiciona um token de segurança interativo a sessões de loopback.</span><span class="sxs-lookup"><span data-stu-id="11fa4-415">Indicates that this cmdlet adds an interactive security token to loopback sessions.</span></span> <span data-ttu-id="11fa4-416">O token interativo permite executar comandos na sessão de loopback que obtêm dados de outros computadores.</span><span class="sxs-lookup"><span data-stu-id="11fa4-416">The interactive token lets you run commands in the loopback session that get data from other computers.</span></span> <span data-ttu-id="11fa4-417">Por exemplo, você pode executar um comando na sessão que copia arquivos XML de um computador remoto no computador local.</span><span class="sxs-lookup"><span data-stu-id="11fa4-417">For example, you can run a command in the session that copies XML files from a remote computer to the local computer.</span></span>

<span data-ttu-id="11fa4-418">Uma sessão de loopback é uma **PSSession** originada e termina no mesmo computador.</span><span class="sxs-lookup"><span data-stu-id="11fa4-418">A loopback session is a **PSSession** that originates and ends on the same computer.</span></span> <span data-ttu-id="11fa4-419">Para criar uma sessão de loopback, omita o parâmetro **ComputerName** ou defina seu valor como ponto ( `.` ), localhost ou o nome do computador local.</span><span class="sxs-lookup"><span data-stu-id="11fa4-419">To create a loopback session, omit the **ComputerName** parameter or set its value to dot (`.`), localhost, or the name of the local computer.</span></span>

<span data-ttu-id="11fa4-420">Por padrão, as sessões de loopback são criadas usando um token de rede, que pode não fornecer permissão suficiente para autenticar em computadores remotos.</span><span class="sxs-lookup"><span data-stu-id="11fa4-420">By default, loopback sessions are created using a network token, which might not provide sufficient permission to authenticate to remote computers.</span></span>

<span data-ttu-id="11fa4-421">O parâmetro **EnableNetworkAccess** só é eficaz em sessões de loopback.</span><span class="sxs-lookup"><span data-stu-id="11fa4-421">The **EnableNetworkAccess** parameter is effective only in loopback sessions.</span></span> <span data-ttu-id="11fa4-422">Se você usar **EnableNetworkAccess** ao criar uma sessão em um computador remoto, o comando terá sucesso, mas o parâmetro será ignorado.</span><span class="sxs-lookup"><span data-stu-id="11fa4-422">If you use **EnableNetworkAccess** when you create a session on a remote computer, the command succeeds, but the parameter is ignored.</span></span>

<span data-ttu-id="11fa4-423">Você pode permitir o acesso remoto em uma sessão de loopback usando o valor **CredSSP** do parâmetro de **autenticação** , que delega as credenciais de sessão para outros computadores.</span><span class="sxs-lookup"><span data-stu-id="11fa4-423">You can allow remote access in a loopback session using the **CredSSP** value of the **Authentication** parameter, which delegates the session credentials to other computers.</span></span>

<span data-ttu-id="11fa4-424">Para proteger o computador contra acesso mal-intencionado, as sessões de loopback desconectadas que têm tokens interativos, que são aquelas criadas usando **EnableNetworkAccess** , podem ser reconectadas somente do computador no qual a sessão foi criada.</span><span class="sxs-lookup"><span data-stu-id="11fa4-424">To protect the computer from malicious access, disconnected loopback sessions that have interactive tokens, which are those created using **EnableNetworkAccess** , can be reconnected only from the computer on which the session was created.</span></span> <span data-ttu-id="11fa4-425">Sessões desconectadas que usam a autenticação CredSSP podem ser reconectadas por meio de outros computadores.</span><span class="sxs-lookup"><span data-stu-id="11fa4-425">Disconnected sessions that use CredSSP authentication can be reconnected from other computers.</span></span> <span data-ttu-id="11fa4-426">Para obter mais informações, consulte `Disconnect-PSSession`.</span><span class="sxs-lookup"><span data-stu-id="11fa4-426">For more information, see `Disconnect-PSSession`.</span></span>

<span data-ttu-id="11fa4-427">Esse parâmetro foi introduzido no PowerShell 3,0.</span><span class="sxs-lookup"><span data-stu-id="11fa4-427">This parameter was introduced in PowerShell 3.0.</span></span>
...
### <span data-ttu-id="11fa4-428">-FilePath</span><span class="sxs-lookup"><span data-stu-id="11fa4-428">-FilePath</span></span>

<span data-ttu-id="11fa4-429">Especifica um script local que esse cmdlet executa em um ou mais computadores remotos.</span><span class="sxs-lookup"><span data-stu-id="11fa4-429">Specifies a local script that this cmdlet runs on one or more remote computers.</span></span> <span data-ttu-id="11fa4-430">Insira o caminho e o nome de arquivo do script ou redirecione um caminho de script para `Invoke-Command` .</span><span class="sxs-lookup"><span data-stu-id="11fa4-430">Enter the path and filename of the script, or pipe a script path to `Invoke-Command`.</span></span> <span data-ttu-id="11fa4-431">O script deve existir no computador local ou em um diretório que o computador local possa acessar.</span><span class="sxs-lookup"><span data-stu-id="11fa4-431">The script must exist on the local computer or in a directory that the local computer can access.</span></span> <span data-ttu-id="11fa4-432">Use **ArgumentList** para especificar os valores dos parâmetros no script.</span><span class="sxs-lookup"><span data-stu-id="11fa4-432">Use **ArgumentList** to specify the values of parameters in the script.</span></span>

<span data-ttu-id="11fa4-433">Quando você usa esse parâmetro, o PowerShell converte o conteúdo do arquivo de script especificado em um bloco de script, transmite o bloco de script para o computador remoto e o executa no computador remoto.</span><span class="sxs-lookup"><span data-stu-id="11fa4-433">When you use this parameter, PowerShell converts the contents of the specified script file to a script block, transmits the script block to the remote computer, and runs it on the remote computer.</span></span>
...
### <span data-ttu-id="11fa4-434">-HideComputerName</span><span class="sxs-lookup"><span data-stu-id="11fa4-434">-HideComputerName</span></span>

<span data-ttu-id="11fa4-435">Indica que esse cmdlet omite o nome do computador de cada objeto da exibição de saída.</span><span class="sxs-lookup"><span data-stu-id="11fa4-435">Indicates that this cmdlet omits the computer name of each object from the output display.</span></span> <span data-ttu-id="11fa4-436">Por padrão, o nome do computador que gerou o objeto aparece na exibição.</span><span class="sxs-lookup"><span data-stu-id="11fa4-436">By default, the name of the computer that generated the object appears in the display.</span></span>

<span data-ttu-id="11fa4-437">Este parâmetro afeta somente a exibição de saída.</span><span class="sxs-lookup"><span data-stu-id="11fa4-437">This parameter affects only the output display.</span></span> <span data-ttu-id="11fa4-438">Ele não altera o objeto.</span><span class="sxs-lookup"><span data-stu-id="11fa4-438">It doesn't change the object.</span></span>
...
### <span data-ttu-id="11fa4-439">-HostName</span><span class="sxs-lookup"><span data-stu-id="11fa4-439">-HostName</span></span>

<span data-ttu-id="11fa4-440">Especifica uma matriz de nomes de computador para uma conexão baseada em Secure Shell (SSH).</span><span class="sxs-lookup"><span data-stu-id="11fa4-440">Specifies an array of computer names for a Secure Shell (SSH) based connection.</span></span> <span data-ttu-id="11fa4-441">Isso é semelhante ao parâmetro **ComputerName** , exceto pelo fato de que a conexão com o computador remoto é feita usando SSH em vez de WinRM do Windows.</span><span class="sxs-lookup"><span data-stu-id="11fa4-441">This is similar to the **ComputerName** parameter except that the connection to the remote computer is made using SSH rather than Windows WinRM.</span></span>

<span data-ttu-id="11fa4-442">Esse parâmetro foi introduzido no PowerShell 6,0.</span><span class="sxs-lookup"><span data-stu-id="11fa4-442">This parameter was introduced in PowerShell 6.0.</span></span>
...
### <span data-ttu-id="11fa4-443">-InDisconnectedSession</span><span class="sxs-lookup"><span data-stu-id="11fa4-443">-InDisconnectedSession</span></span>

<span data-ttu-id="11fa4-444">Indica que este cmdlet executa um comando ou script em uma sessão desconectada.</span><span class="sxs-lookup"><span data-stu-id="11fa4-444">Indicates that this cmdlet runs a command or script in a disconnected session.</span></span>

<span data-ttu-id="11fa4-445">Quando você usa o parâmetro **InDisconnectedSession** , o `Invoke-Command` cria uma sessão persistente em cada computador remoto, inicia o comando especificado pelo parâmetro **scriptblock** ou **FilePath** e, em seguida, desconecta-se da sessão.</span><span class="sxs-lookup"><span data-stu-id="11fa4-445">When you use the **InDisconnectedSession** parameter, `Invoke-Command` creates a persistent session on each remote computer, starts the command specified by the **ScriptBlock** or **FilePath** parameter, and then disconnects from the session.</span></span> <span data-ttu-id="11fa4-446">Os comandos continuam a ser executados nas sessões desconectadas.</span><span class="sxs-lookup"><span data-stu-id="11fa4-446">The commands continue to run in the disconnected sessions.</span></span> <span data-ttu-id="11fa4-447">O **InDisconnectedSession** permite que você execute comandos sem manter uma conexão com as sessões remotas.</span><span class="sxs-lookup"><span data-stu-id="11fa4-447">**InDisconnectedSession** enables you to run commands without maintaining a connection to the remote sessions.</span></span> <span data-ttu-id="11fa4-448">E, como a sessão é desconectada antes de qualquer resultado ser retornado, o **InDisconnectedSession** garante que todos os resultados de comando sejam retornados para a sessão reconectada, em vez de serem divididos entre as sessões.</span><span class="sxs-lookup"><span data-stu-id="11fa4-448">And, because the session is disconnected before any results are returned, **InDisconnectedSession** makes sure that all command results are returned to the reconnected session, instead of being split between sessions.</span></span>

<span data-ttu-id="11fa4-449">Você não pode usar **InDisconnectedSession** com o parâmetro **Session** ou o parâmetro **AsJob** .</span><span class="sxs-lookup"><span data-stu-id="11fa4-449">You can't use **InDisconnectedSession** with the **Session** parameter or the **AsJob** parameter.</span></span>

<span data-ttu-id="11fa4-450">Comandos que usam **InDisconnectedSession** retornam um objeto **PSSession** que representa a sessão desconectada.</span><span class="sxs-lookup"><span data-stu-id="11fa4-450">Commands that use **InDisconnectedSession** return a **PSSession** object that represents the disconnected session.</span></span> <span data-ttu-id="11fa4-451">Eles não retornam a saída do comando.</span><span class="sxs-lookup"><span data-stu-id="11fa4-451">They don't return the command output.</span></span> <span data-ttu-id="11fa4-452">Para se conectar à sessão desconectada, use os `Connect-PSSession` `Receive-PSSession` cmdlets ou.</span><span class="sxs-lookup"><span data-stu-id="11fa4-452">To connect to the disconnected session, use the `Connect-PSSession` or `Receive-PSSession` cmdlets.</span></span> <span data-ttu-id="11fa4-453">Para obter os resultados dos comandos que foram executados na sessão, use o `Receive-PSSession` cmdlet.</span><span class="sxs-lookup"><span data-stu-id="11fa4-453">To get the results of commands that ran in the session, use the `Receive-PSSession` cmdlet.</span></span> <span data-ttu-id="11fa4-454">Para executar comandos que geram saída em uma sessão desconectada, defina o valor da opção de sessão **OutputBufferingMode** como **drop** .</span><span class="sxs-lookup"><span data-stu-id="11fa4-454">To run commands that generate output in a disconnected session, set the value of the **OutputBufferingMode** session option to **Drop** .</span></span> <span data-ttu-id="11fa4-455">Se você pretende se conectar à sessão desconectada, defina o tempo limite ocioso na sessão para que ela forneça tempo suficiente para que você se conecte antes de excluir a sessão.</span><span class="sxs-lookup"><span data-stu-id="11fa4-455">If you intend to connect to the disconnected session, set the idle time-out in the session so that it provides sufficient time for you to connect before deleting the session.</span></span>

<span data-ttu-id="11fa4-456">Você pode definir o modo de buffer de saída e o tempo limite ocioso no parâmetro **SessionOption** ou na `$PSSessionOption` variável de preferência.</span><span class="sxs-lookup"><span data-stu-id="11fa4-456">You can set the output buffering mode and idle time-out in the **SessionOption** parameter or in the `$PSSessionOption` preference variable.</span></span> <span data-ttu-id="11fa4-457">Para obter mais informações sobre as opções de sessão, consulte `New-PSSessionOption` e [about_Preference_Variables](./about/about_preference_variables.md).</span><span class="sxs-lookup"><span data-stu-id="11fa4-457">For more information about session options, see `New-PSSessionOption` and [about_Preference_Variables](./about/about_preference_variables.md).</span></span>

<span data-ttu-id="11fa4-458">Para obter mais informações sobre o recurso de Sessões desconectadas, consulte [about_Remote_Disconnected_Sessions](about/about_Remote_Disconnected_Sessions.md).</span><span class="sxs-lookup"><span data-stu-id="11fa4-458">For more information about the Disconnected Sessions feature, see [about_Remote_Disconnected_Sessions](about/about_Remote_Disconnected_Sessions.md).</span></span>

<span data-ttu-id="11fa4-459">Esse parâmetro foi introduzido no PowerShell 3,0.</span><span class="sxs-lookup"><span data-stu-id="11fa4-459">This parameter was introduced in PowerShell 3.0.</span></span>
...
### <span data-ttu-id="11fa4-460">-InputObject</span><span class="sxs-lookup"><span data-stu-id="11fa4-460">-InputObject</span></span>

<span data-ttu-id="11fa4-461">Especifica a entrada para o comando.</span><span class="sxs-lookup"><span data-stu-id="11fa4-461">Specifies input to the command.</span></span> <span data-ttu-id="11fa4-462">Insira uma variável que contém os objetos ou digite um comando ou uma expressão que obtém os objetos.</span><span class="sxs-lookup"><span data-stu-id="11fa4-462">Enter a variable that contains the objects or type a command or expression that gets the objects.</span></span>

<span data-ttu-id="11fa4-463">Ao usar o parâmetro **InputObject** , use a `$Input` variável automática no valor do parâmetro **scriptblock** para representar os objetos de entrada.</span><span class="sxs-lookup"><span data-stu-id="11fa4-463">When using the **InputObject** parameter, use the `$Input` automatic variable in the value of the **ScriptBlock** parameter to represent the input objects.</span></span>
...
### <span data-ttu-id="11fa4-464">-JobName</span><span class="sxs-lookup"><span data-stu-id="11fa4-464">-JobName</span></span>

<span data-ttu-id="11fa4-465">Especifica um nome amigável para o trabalho em segundo plano.</span><span class="sxs-lookup"><span data-stu-id="11fa4-465">Specifies a friendly name for the background job.</span></span> <span data-ttu-id="11fa4-466">Por padrão, os trabalhos são nomeados `Job<n>` , em que `<n>` é um número ordinal.</span><span class="sxs-lookup"><span data-stu-id="11fa4-466">By default, jobs are named `Job<n>`, where `<n>` is an ordinal number.</span></span>

<span data-ttu-id="11fa4-467">Se você usar o parâmetro **JobName** em um comando, o comando será executado como um trabalho e `Invoke-Command` retornará um objeto de trabalho, mesmo que você não inclua **AsJob** no comando.</span><span class="sxs-lookup"><span data-stu-id="11fa4-467">If you use the **JobName** parameter in a command, the command is run as a job, and `Invoke-Command` returns a job object, even if you don't include **AsJob** in the command.</span></span>

<span data-ttu-id="11fa4-468">Para obter mais informações sobre trabalhos em segundo plano do PowerShell, consulte [about_Jobs](./About/about_Jobs.md).</span><span class="sxs-lookup"><span data-stu-id="11fa4-468">For more information about PowerShell background jobs, see [about_Jobs](./About/about_Jobs.md).</span></span>
...
### <span data-ttu-id="11fa4-469">-KeyFilePath</span><span class="sxs-lookup"><span data-stu-id="11fa4-469">-KeyFilePath</span></span>

<span data-ttu-id="11fa4-470">Especifica um caminho de arquivo de chave usado pelo Secure Shell (SSH) para autenticar um usuário em um computador remoto.</span><span class="sxs-lookup"><span data-stu-id="11fa4-470">Specifies a key file path used by Secure Shell (SSH) to authenticate a user on a remote computer.</span></span>

<span data-ttu-id="11fa4-471">O SSH permite que a autenticação do usuário seja executada por meio de chaves públicas e privadas como uma alternativa à autenticação de senha básica.</span><span class="sxs-lookup"><span data-stu-id="11fa4-471">SSH allows user authentication to be performed via private and public keys as an alternative to basic password authentication.</span></span> <span data-ttu-id="11fa4-472">Se o computador remoto estiver configurado para autenticação de chave, esse parâmetro poderá ser usado para fornecer a chave que identifica o usuário.</span><span class="sxs-lookup"><span data-stu-id="11fa4-472">If the remote computer is configured for key authentication, then this parameter can be used to provide the key that identifies the user.</span></span>

<span data-ttu-id="11fa4-473">Esse parâmetro foi introduzido no PowerShell 6,0.</span><span class="sxs-lookup"><span data-stu-id="11fa4-473">This parameter was introduced in PowerShell 6.0.</span></span>
...
### <span data-ttu-id="11fa4-474">-NoNewScope</span><span class="sxs-lookup"><span data-stu-id="11fa4-474">-NoNewScope</span></span>

<span data-ttu-id="11fa4-475">Indica que esse cmdlet executa o comando especificado no escopo atual.</span><span class="sxs-lookup"><span data-stu-id="11fa4-475">Indicates that this cmdlet runs the specified command in the current scope.</span></span> <span data-ttu-id="11fa4-476">Por padrão, `Invoke-Command` o executa comandos em seu próprio escopo.</span><span class="sxs-lookup"><span data-stu-id="11fa4-476">By default, `Invoke-Command` runs commands in their own scope.</span></span>

<span data-ttu-id="11fa4-477">Esse parâmetro é válido somente em comandos que são executados na sessão atual, ou seja, comandos que omitem ambos os parâmetros **ComputerName** e **Session** .</span><span class="sxs-lookup"><span data-stu-id="11fa4-477">This parameter is valid only in commands that are run in the current session, that is, commands that omit both the **ComputerName** and **Session** parameters.</span></span>

<span data-ttu-id="11fa4-478">Esse parâmetro foi introduzido no PowerShell 3,0.</span><span class="sxs-lookup"><span data-stu-id="11fa4-478">This parameter was introduced in PowerShell 3.0.</span></span>
...
### <span data-ttu-id="11fa4-479">-Port</span><span class="sxs-lookup"><span data-stu-id="11fa4-479">-Port</span></span>

<span data-ttu-id="11fa4-480">Especifica a porta de rede no computador remoto que é usada para este comando.</span><span class="sxs-lookup"><span data-stu-id="11fa4-480">Specifies the network port on the remote computer that is used for this command.</span></span> <span data-ttu-id="11fa4-481">Para se conectar a um computador remoto, este deve estar escutando na porta usada pela conexão.</span><span class="sxs-lookup"><span data-stu-id="11fa4-481">To connect to a remote computer, the remote computer must be listening on the port that the connection uses.</span></span> <span data-ttu-id="11fa4-482">As portas padrão são 5985 (porta do WinRM para HTTP) e 5986 (porta do WinRM para HTTPS).</span><span class="sxs-lookup"><span data-stu-id="11fa4-482">The default ports are 5985 (WinRM port for HTTP) and 5986 (WinRM port for HTTPS).</span></span>

<span data-ttu-id="11fa4-483">Antes de usar uma porta alternativa, configure o ouvinte WinRM no computador remoto para escutar na porta.</span><span class="sxs-lookup"><span data-stu-id="11fa4-483">Before using an alternate port, configure the WinRM listener on the remote computer to listen at that port.</span></span> <span data-ttu-id="11fa4-484">Para configurar o ouvinte, digite os dois comandos a seguir no prompt do PowerShell:</span><span class="sxs-lookup"><span data-stu-id="11fa4-484">To configure the listener, type the following two commands at the PowerShell prompt:</span></span>

`Remove-Item -Path WSMan:\Localhost\listener\listener* -Recurse`

`New-Item -Path WSMan:\Localhost\listener -Transport http -Address * -Port \<port-number\>`

<span data-ttu-id="11fa4-485">Não use o parâmetro **Port** , a menos que você precise.</span><span class="sxs-lookup"><span data-stu-id="11fa4-485">Don't use the **Port** parameter unless you must.</span></span> <span data-ttu-id="11fa4-486">A porta que está definida no comando se aplica a todos os computadores ou sessões em que o comando é executado.</span><span class="sxs-lookup"><span data-stu-id="11fa4-486">The port that is set in the command applies to all computers or sessions on which the command runs.</span></span> <span data-ttu-id="11fa4-487">Uma configuração de porta alternativa pode impedir que o comando seja executado em todos os computadores.</span><span class="sxs-lookup"><span data-stu-id="11fa4-487">An alternate port setting might prevent the command from running on all computers.</span></span>
...
### <span data-ttu-id="11fa4-488">-RemoteDebug</span><span class="sxs-lookup"><span data-stu-id="11fa4-488">-RemoteDebug</span></span>

<span data-ttu-id="11fa4-489">Usado para executar o comando chamado no modo de depuração na sessão remota do PowerShell.</span><span class="sxs-lookup"><span data-stu-id="11fa4-489">Used to run the invoked command in debug mode in the remote PowerShell session.</span></span>
...
### <span data-ttu-id="11fa4-490">-RunAsAdministrator</span><span class="sxs-lookup"><span data-stu-id="11fa4-490">-RunAsAdministrator</span></span>

<span data-ttu-id="11fa4-491">Indica que esse cmdlet invoca um comando como administrador.</span><span class="sxs-lookup"><span data-stu-id="11fa4-491">Indicates that this cmdlet invokes a command as an Administrator.</span></span>
...
### <span data-ttu-id="11fa4-492">-ScriptBlock</span><span class="sxs-lookup"><span data-stu-id="11fa4-492">-ScriptBlock</span></span>

<span data-ttu-id="11fa4-493">Especifica os comandos a serem executados.</span><span class="sxs-lookup"><span data-stu-id="11fa4-493">Specifies the commands to run.</span></span> <span data-ttu-id="11fa4-494">Coloque os comandos entre chaves `{ }` para criar um bloco de script.</span><span class="sxs-lookup"><span data-stu-id="11fa4-494">Enclose the commands in curly braces `{ }` to create a script block.</span></span>
<span data-ttu-id="11fa4-495">Este parâmetro é necessário.</span><span class="sxs-lookup"><span data-stu-id="11fa4-495">This parameter is required.</span></span>

<span data-ttu-id="11fa4-496">Por padrão, todas as variáveis no comando são avaliadas no computador remoto.</span><span class="sxs-lookup"><span data-stu-id="11fa4-496">By default, any variables in the command are evaluated on the remote computer.</span></span> <span data-ttu-id="11fa4-497">Para incluir variáveis locais no comando, use **ArgumentList** .</span><span class="sxs-lookup"><span data-stu-id="11fa4-497">To include local variables in the command, use **ArgumentList** .</span></span>
...
### <span data-ttu-id="11fa4-498">-Sessão</span><span class="sxs-lookup"><span data-stu-id="11fa4-498">-Session</span></span>

<span data-ttu-id="11fa4-499">Especifica uma matriz de sessões em que esse cmdlet executa o comando.</span><span class="sxs-lookup"><span data-stu-id="11fa4-499">Specifies an array of sessions in which this cmdlet runs the command.</span></span> <span data-ttu-id="11fa4-500">Insira uma variável que contenha objetos **PSSession** ou um comando que cria ou obtém os objetos **PSSession** , como um `New-PSSession` `Get-PSSession` comando ou.</span><span class="sxs-lookup"><span data-stu-id="11fa4-500">Enter a variable that contains **PSSession** objects or a command that creates or gets the **PSSession** objects, such as a `New-PSSession` or `Get-PSSession` command.</span></span>

<span data-ttu-id="11fa4-501">Quando você cria uma **PSSession** , o PowerShell estabelece uma conexão persistente com o computador remoto.</span><span class="sxs-lookup"><span data-stu-id="11fa4-501">When you create a **PSSession** , PowerShell establishes a persistent connection to the remote computer.</span></span> <span data-ttu-id="11fa4-502">Use uma **PSSession** para executar uma série de comandos relacionados que compartilham dados.</span><span class="sxs-lookup"><span data-stu-id="11fa4-502">Use a **PSSession** to run a series of related commands that share data.</span></span> <span data-ttu-id="11fa4-503">Para executar um único comando ou uma série de comandos não relacionados, use o parâmetro **ComputerName** .</span><span class="sxs-lookup"><span data-stu-id="11fa4-503">To run a single command or a series of unrelated commands, use the **ComputerName** parameter.</span></span> <span data-ttu-id="11fa4-504">Para obter mais informações, consulte [about_PSSessions](./About/about_PSSessions.md).</span><span class="sxs-lookup"><span data-stu-id="11fa4-504">For more information, see [about_PSSessions](./About/about_PSSessions.md).</span></span>
...
### <span data-ttu-id="11fa4-505">-SESSIONNAME</span><span class="sxs-lookup"><span data-stu-id="11fa4-505">-SessionName</span></span>

<span data-ttu-id="11fa4-506">Especifica um nome amigável para uma sessão desconectada.</span><span class="sxs-lookup"><span data-stu-id="11fa4-506">Specifies a friendly name for a disconnected session.</span></span> <span data-ttu-id="11fa4-507">Você pode usar o nome para fazer referência à sessão em comandos subsequentes, como um `Get-PSSession` comando.</span><span class="sxs-lookup"><span data-stu-id="11fa4-507">You can use the name to refer to the session in subsequent commands, such as a `Get-PSSession` command.</span></span> <span data-ttu-id="11fa4-508">Esse parâmetro é válido somente com o parâmetro **InDisconnectedSession** .</span><span class="sxs-lookup"><span data-stu-id="11fa4-508">This parameter is valid only with the **InDisconnectedSession** parameter.</span></span>

<span data-ttu-id="11fa4-509">Esse parâmetro foi introduzido no PowerShell 3,0.</span><span class="sxs-lookup"><span data-stu-id="11fa4-509">This parameter was introduced in PowerShell 3.0.</span></span>
...
### <span data-ttu-id="11fa4-510">-SessionOption</span><span class="sxs-lookup"><span data-stu-id="11fa4-510">-SessionOption</span></span>

<span data-ttu-id="11fa4-511">Especifica as opções avançadas para a sessão.</span><span class="sxs-lookup"><span data-stu-id="11fa4-511">Specifies advanced options for the session.</span></span> <span data-ttu-id="11fa4-512">Insira um objeto **SessionOption** , como um que você cria usando o `New-PSSessionOption` cmdlet ou uma tabela de hash na qual as chaves são nomes de opção de sessão e os valores são valores de opção de sessão.</span><span class="sxs-lookup"><span data-stu-id="11fa4-512">Enter a **SessionOption** object, such as one that you create using the `New-PSSessionOption` cmdlet, or a hash table in which the keys are session option names and the values are session option values.</span></span>

<span data-ttu-id="11fa4-513">Os valores padrão para as opções são determinados pelo valor da variável de `$PSSessionOption` preferência, se ele estiver definido.</span><span class="sxs-lookup"><span data-stu-id="11fa4-513">The default values for the options are determined by the value of the `$PSSessionOption` preference variable, if it's set.</span></span> <span data-ttu-id="11fa4-514">Caso contrário, os valores padrão são estabelecidos por opções definidas na configuração da sessão.</span><span class="sxs-lookup"><span data-stu-id="11fa4-514">Otherwise, the default values are established by options set in the session configuration.</span></span>

<span data-ttu-id="11fa4-515">Os valores de opção de sessão têm precedência sobre valores padrão para sessões definidas na `$PSSessionOption` variável de preferência e na configuração da sessão.</span><span class="sxs-lookup"><span data-stu-id="11fa4-515">The session option values take precedence over default values for sessions set in the `$PSSessionOption` preference variable and in the session configuration.</span></span> <span data-ttu-id="11fa4-516">No entanto, eles não têm precedência sobre os valores máximos, cotas ou limites definidos na configuração da sessão.</span><span class="sxs-lookup"><span data-stu-id="11fa4-516">However, they don't take precedence over maximum values, quotas, or limits set in the session configuration.</span></span>

<span data-ttu-id="11fa4-517">Para obter uma descrição das opções de sessão que incluem os valores padrão, consulte `New-PSSessionOption` .</span><span class="sxs-lookup"><span data-stu-id="11fa4-517">For a description of the session options that includes the default values, see `New-PSSessionOption`.</span></span> <span data-ttu-id="11fa4-518">Para obter informações sobre a `$PSSessionOption` variável de preferência, consulte [about_Preference_Variables](About/about_Preference_Variables.md).</span><span class="sxs-lookup"><span data-stu-id="11fa4-518">For information about the `$PSSessionOption` preference variable, see [about_Preference_Variables](About/about_Preference_Variables.md).</span></span>
<span data-ttu-id="11fa4-519">Para obter mais informações sobre configurações de sessão, consulte [about_Session_Configurations](About/about_Session_Configurations.md).</span><span class="sxs-lookup"><span data-stu-id="11fa4-519">For more information about session configurations, see [about_Session_Configurations](About/about_Session_Configurations.md).</span></span>
...
### <span data-ttu-id="11fa4-520">-SSHConnection</span><span class="sxs-lookup"><span data-stu-id="11fa4-520">-SSHConnection</span></span>

<span data-ttu-id="11fa4-521">Esse parâmetro usa uma matriz de tabelas de hash em que cada tabela de hash contém um ou mais parâmetros de conexão necessários para estabelecer uma conexão de Secure Shell (SSH).</span><span class="sxs-lookup"><span data-stu-id="11fa4-521">This parameter takes an array of hash tables where each hash table contains one or more connection parameters needed to establish a Secure Shell (SSH) connection.</span></span> <span data-ttu-id="11fa4-522">O parâmetro **SSHConnection** é útil para criar várias sessões em que cada sessão requer informações de conexão diferentes.</span><span class="sxs-lookup"><span data-stu-id="11fa4-522">The **SSHConnection** parameter is useful for creating multiple sessions where each session requires different connection information.</span></span>

<span data-ttu-id="11fa4-523">A tabela de hash tem os seguintes membros:</span><span class="sxs-lookup"><span data-stu-id="11fa4-523">The hashtable has the following members:</span></span>

- <span data-ttu-id="11fa4-524">**Nome do** **computador** (ou hostname)</span><span class="sxs-lookup"><span data-stu-id="11fa4-524">**ComputerName** (or **HostName** )</span></span>
- <span data-ttu-id="11fa4-525">**Porta**</span><span class="sxs-lookup"><span data-stu-id="11fa4-525">**Port**</span></span>
- <span data-ttu-id="11fa4-526">**UserName**</span><span class="sxs-lookup"><span data-stu-id="11fa4-526">**UserName**</span></span>
- <span data-ttu-id="11fa4-527">**KeyFilePath** (ou **IdentityFilePath** )</span><span class="sxs-lookup"><span data-stu-id="11fa4-527">**KeyFilePath** (or **IdentityFilePath** )</span></span>

<span data-ttu-id="11fa4-528">**ComputerName** (ou **hostname** ) é o único par chave-valor necessário.</span><span class="sxs-lookup"><span data-stu-id="11fa4-528">**ComputerName** (or **HostName** ) is the only key-value pair that is required.</span></span>

<span data-ttu-id="11fa4-529">Esse parâmetro foi introduzido no PowerShell 6,0.</span><span class="sxs-lookup"><span data-stu-id="11fa4-529">This parameter was introduced in PowerShell 6.0.</span></span>
...
### <span data-ttu-id="11fa4-530">-SSHTransport</span><span class="sxs-lookup"><span data-stu-id="11fa4-530">-SSHTransport</span></span>

<span data-ttu-id="11fa4-531">Indica que a conexão remota é estabelecida usando Secure Shell (SSH).</span><span class="sxs-lookup"><span data-stu-id="11fa4-531">Indicates that the remote connection is established using Secure Shell (SSH).</span></span>

<span data-ttu-id="11fa4-532">Por padrão, o PowerShell usa o Windows WinRM para se conectar a um computador remoto.</span><span class="sxs-lookup"><span data-stu-id="11fa4-532">By default PowerShell uses Windows WinRM to connect to a remote computer.</span></span> <span data-ttu-id="11fa4-533">Essa opção força o PowerShell a usar o parâmetro **hostname** para estabelecer uma conexão remota com base em SSH.</span><span class="sxs-lookup"><span data-stu-id="11fa4-533">This switch forces PowerShell to use the **HostName** parameter for establishing an SSH based remote connection.</span></span>

<span data-ttu-id="11fa4-534">Esse parâmetro foi introduzido no PowerShell 6,0.</span><span class="sxs-lookup"><span data-stu-id="11fa4-534">This parameter was introduced in PowerShell 6.0.</span></span>
...
### <span data-ttu-id="11fa4-535">-ThrottleLimit</span><span class="sxs-lookup"><span data-stu-id="11fa4-535">-ThrottleLimit</span></span>

<span data-ttu-id="11fa4-536">Especifica o número máximo de conexões simultâneas que podem ser estabelecidas para executar o comando.</span><span class="sxs-lookup"><span data-stu-id="11fa4-536">Specifies the maximum number of concurrent connections that can be established to run this command.</span></span>
<span data-ttu-id="11fa4-537">Se você omite esse parâmetro ou digita um valor 0, o valor padrão, 32, é usado.</span><span class="sxs-lookup"><span data-stu-id="11fa4-537">If you omit this parameter or enter a value of 0, the default value, 32, is used.</span></span>

<span data-ttu-id="11fa4-538">O limite de aceleração aplica-se somente ao comando atual e não à sessão ou ao computador.</span><span class="sxs-lookup"><span data-stu-id="11fa4-538">The throttle limit applies only to the current command, not to the session or to the computer.</span></span>
...
### <span data-ttu-id="11fa4-539">-UserName</span><span class="sxs-lookup"><span data-stu-id="11fa4-539">-UserName</span></span>

<span data-ttu-id="11fa4-540">Especifica o nome de usuário para a conta usada para executar um comando no computador remoto.</span><span class="sxs-lookup"><span data-stu-id="11fa4-540">Specifies the username for the account used to run a command on the remote computer.</span></span> <span data-ttu-id="11fa4-541">O método de autenticação de usuário depende de como o Secure Shell (SSH) é configurado no computador remoto.</span><span class="sxs-lookup"><span data-stu-id="11fa4-541">The user authentication method depends on how Secure Shell (SSH) is configured on the remote computer.</span></span>

<span data-ttu-id="11fa4-542">Se o SSH estiver configurado para autenticação de senha básica, a senha do usuário será solicitada.</span><span class="sxs-lookup"><span data-stu-id="11fa4-542">If SSH is configured for basic password authentication, then you'll be prompted for the user password.</span></span>

<span data-ttu-id="11fa4-543">Se o SSH estiver configurado para autenticação de usuário baseada em chave, um caminho de arquivo de chave poderá ser fornecido por meio do parâmetro **keyFilePath** e nenhum prompt de senha ocorrerá.</span><span class="sxs-lookup"><span data-stu-id="11fa4-543">If SSH is configured for key-based user authentication then a key file path can be provided via the **KeyFilePath** parameter and no password prompt occurs.</span></span> <span data-ttu-id="11fa4-544">Se o arquivo de chave de usuário do cliente estiver localizado em um local de SSH conhecido, o parâmetro **keyFilePath** não será necessário para a autenticação baseada em chave e a autenticação do usuário ocorrerá automaticamente com base no nome de usuário.</span><span class="sxs-lookup"><span data-stu-id="11fa4-544">If the client user key file is located in an SSH known location, then the **KeyFilePath** parameter isn't needed for key-based authentication, and user authentication occurs automatically based on the username.</span></span> <span data-ttu-id="11fa4-545">Para obter mais informações, consulte a documentação do SSH da sua plataforma sobre a autenticação de usuário baseada em chave.</span><span class="sxs-lookup"><span data-stu-id="11fa4-545">For more information, see your platform's SSH documentation about key-based user authentication.</span></span>

<span data-ttu-id="11fa4-546">Esse não é um parâmetro obrigatório.</span><span class="sxs-lookup"><span data-stu-id="11fa4-546">This isn't a required parameter.</span></span> <span data-ttu-id="11fa4-547">Se o parâmetro **username** não for especificado, o nome de usuário conectado no momento será usado para a conexão.</span><span class="sxs-lookup"><span data-stu-id="11fa4-547">If the **UserName** parameter isn't specified, then the current logged on username is used for the connection.</span></span>

<span data-ttu-id="11fa4-548">Esse parâmetro foi introduzido no PowerShell 6,0.</span><span class="sxs-lookup"><span data-stu-id="11fa4-548">This parameter was introduced in PowerShell 6.0.</span></span>
...
### <span data-ttu-id="11fa4-549">-UseSSL</span><span class="sxs-lookup"><span data-stu-id="11fa4-549">-UseSSL</span></span>

<span data-ttu-id="11fa4-550">Indica que esse cmdlet usa o protocolo protocolo SSL (SSL) para estabelecer uma conexão com o computador remoto.</span><span class="sxs-lookup"><span data-stu-id="11fa4-550">Indicates that this cmdlet uses the Secure Sockets Layer (SSL) protocol to establish a connection to the remote computer.</span></span> <span data-ttu-id="11fa4-551">Por padrão, o SSL não é usado.</span><span class="sxs-lookup"><span data-stu-id="11fa4-551">By default, SSL isn't used.</span></span>

<span data-ttu-id="11fa4-552">WS-Management criptografa todo o conteúdo do PowerShell transmitido pela rede.</span><span class="sxs-lookup"><span data-stu-id="11fa4-552">WS-Management encrypts all PowerShell content transmitted over the network.</span></span> <span data-ttu-id="11fa4-553">O parâmetro **UseSSL** é uma proteção adicional que envia os dados por um https, em vez de http.</span><span class="sxs-lookup"><span data-stu-id="11fa4-553">The **UseSSL** parameter is an additional protection that sends the data across an HTTPS, instead of HTTP.</span></span>

<span data-ttu-id="11fa4-554">Se você usar esse parâmetro, mas o SSL não estiver disponível na porta usada para o comando, o comando falhará.</span><span class="sxs-lookup"><span data-stu-id="11fa4-554">If you use this parameter, but SSL isn't available on the port that's used for the command, the command fails.</span></span>
...
### <span data-ttu-id="11fa4-555">-VMId</span><span class="sxs-lookup"><span data-stu-id="11fa4-555">-VMId</span></span>

<span data-ttu-id="11fa4-556">Especifica uma matriz de IDs de máquinas virtuais.</span><span class="sxs-lookup"><span data-stu-id="11fa4-556">Specifies an array of IDs of virtual machines.</span></span>
...
### <span data-ttu-id="11fa4-557">-VMName</span><span class="sxs-lookup"><span data-stu-id="11fa4-557">-VMName</span></span>

<span data-ttu-id="11fa4-558">Especifica uma matriz de nomes de máquinas virtuais.</span><span class="sxs-lookup"><span data-stu-id="11fa4-558">Specifies an array of names of virtual machines.</span></span>
...
### <span data-ttu-id="11fa4-559">-Subsistema</span><span class="sxs-lookup"><span data-stu-id="11fa4-559">-Subsystem</span></span>

<span data-ttu-id="11fa4-560">Especifica o subsistema SSH usado para a nova **PSSession** .</span><span class="sxs-lookup"><span data-stu-id="11fa4-560">Specifies the SSH subsystem used for the new **PSSession** .</span></span>

<span data-ttu-id="11fa4-561">Isso especifica o subsistema a ser usado no destino, conforme definido em sshd_config.</span><span class="sxs-lookup"><span data-stu-id="11fa4-561">This specifies the subsystem to use on the target as defined in sshd_config.</span></span>
<span data-ttu-id="11fa4-562">O subsistema inicia uma versão específica do PowerShell com parâmetros predefinidos.</span><span class="sxs-lookup"><span data-stu-id="11fa4-562">The subsystem starts a specific version of PowerShell with predefined parameters.</span></span>
<span data-ttu-id="11fa4-563">Se o subsistema especificado não existir no computador remoto, o comando falhará.</span><span class="sxs-lookup"><span data-stu-id="11fa4-563">If the specified subsystem does not exist on the remote computer, the command fails.</span></span>

<span data-ttu-id="11fa4-564">Se esse parâmetro não for usado, o padrão será o subsistema ' PowerShell '.</span><span class="sxs-lookup"><span data-stu-id="11fa4-564">If this parameter is not used, the default is the 'powershell' subsystem.</span></span>
...
### <span data-ttu-id="11fa4-565">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="11fa4-565">CommonParameters</span></span>

<span data-ttu-id="11fa4-566">Este cmdlet oferece suporte aos parâmetros comuns: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction e -WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="11fa4-566">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="11fa4-567">Para obter mais informações, confira [about_CommonParameters](https://go.microsoft.com/fwlink/?LinkID=113216).</span><span class="sxs-lookup"><span data-stu-id="11fa4-567">For more information, see [about_CommonParameters](https://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="11fa4-568">ENTRADAS</span><span class="sxs-lookup"><span data-stu-id="11fa4-568">INPUTS</span></span>

### <span data-ttu-id="11fa4-569">System. Management. Automation. ScriptBlock</span><span class="sxs-lookup"><span data-stu-id="11fa4-569">System.Management.Automation.ScriptBlock</span></span>

<span data-ttu-id="11fa4-570">É possível canalizar um comando em um bloco de script para `Invoke-Command` .</span><span class="sxs-lookup"><span data-stu-id="11fa4-570">You can pipe a command in a script block to `Invoke-Command`.</span></span> <span data-ttu-id="11fa4-571">Use a `$Input` variável automática para representar os objetos de entrada no comando.</span><span class="sxs-lookup"><span data-stu-id="11fa4-571">Use the `$Input` automatic variable to represent the input objects in the command.</span></span>

## <span data-ttu-id="11fa4-572">SAÍDAS</span><span class="sxs-lookup"><span data-stu-id="11fa4-572">OUTPUTS</span></span>

### <span data-ttu-id="11fa4-573">System. Management. Automation. PSRemotingJob, System. Management. Automation. Runspaces. PSSession ou a saída do comando invocado</span><span class="sxs-lookup"><span data-stu-id="11fa4-573">System.Management.Automation.PSRemotingJob, System.Management.Automation.Runspaces.PSSession, or the output of the invoked command</span></span>

<span data-ttu-id="11fa4-574">Esse cmdlet retorna um objeto de trabalho, se você usar o parâmetro **AsJob** .</span><span class="sxs-lookup"><span data-stu-id="11fa4-574">This cmdlet returns a job object, if you use the **AsJob** parameter.</span></span> <span data-ttu-id="11fa4-575">Se você especificar o parâmetro **InDisconnectedSession** , `Invoke-Command` retornará um objeto **PSSession** .</span><span class="sxs-lookup"><span data-stu-id="11fa4-575">If you specify the **InDisconnectedSession** parameter, `Invoke-Command` returns a **PSSession** object.</span></span> <span data-ttu-id="11fa4-576">Caso contrário, ele retorna a saída do comando invocado, que é o valor do parâmetro **scriptblock** .</span><span class="sxs-lookup"><span data-stu-id="11fa4-576">Otherwise, it returns the output of the invoked command, which is the value of the **ScriptBlock** parameter.</span></span>

## <span data-ttu-id="11fa4-577">OBSERVAÇÕES</span><span class="sxs-lookup"><span data-stu-id="11fa4-577">NOTES</span></span>

<span data-ttu-id="11fa4-578">No Windows Vista e versões posteriores do sistema operacional Windows, para usar o parâmetro **ComputerName** do `Invoke-Command` para executar um comando no computador local, você deve executar o PowerShell usando a opção **Executar como administrador** .</span><span class="sxs-lookup"><span data-stu-id="11fa4-578">On Windows Vista, and later versions of the Windows operating system, to use the **ComputerName** parameter of `Invoke-Command` to run a command on the local computer, you must run PowerShell using the **Run as administrator** option.</span></span>

<span data-ttu-id="11fa4-579">Quando você executa comandos em vários computadores, o PowerShell se conecta aos computadores na ordem em que aparecem na lista.</span><span class="sxs-lookup"><span data-stu-id="11fa4-579">When you run commands on multiple computers, PowerShell connects to the computers in the order in which they appear in the list.</span></span> <span data-ttu-id="11fa4-580">No entanto, a saída do comando é exibida na ordem em que ela é recebida dos computadores remotos, o que pode ser diferente.</span><span class="sxs-lookup"><span data-stu-id="11fa4-580">However, the command output is displayed in the order that it's received from the remote computers, which might be different.</span></span>

<span data-ttu-id="11fa4-581">Os erros resultantes do comando `Invoke-Command` executado são incluídos nos resultados do comando.</span><span class="sxs-lookup"><span data-stu-id="11fa4-581">Errors that result from the command that `Invoke-Command` runs are included in the command results.</span></span>
<span data-ttu-id="11fa4-582">Erros que poderiam ser erros de finalização em um comando local são tratados como erros de não finalização em um comando remoto.</span><span class="sxs-lookup"><span data-stu-id="11fa4-582">Errors that would be terminating errors in a local command are treated as non-terminating errors in a remote command.</span></span> <span data-ttu-id="11fa4-583">Essa estratégia garante que os erros de encerramento em um computador não fechem o comando em todos os computadores nos quais ele é executado.</span><span class="sxs-lookup"><span data-stu-id="11fa4-583">This strategy makes sure that terminating errors on one computer don't close the command on all computers on which it's run.</span></span> <span data-ttu-id="11fa4-584">Essa prática é utilizada mesmo quando um comando remoto é executado em um único computador.</span><span class="sxs-lookup"><span data-stu-id="11fa4-584">This practice is used even when a remote command is run on a single computer.</span></span>

<span data-ttu-id="11fa4-585">Se o computador remoto não estiver em um domínio no qual o computador local confia, talvez o computador não consiga autenticar as credenciais do usuário.</span><span class="sxs-lookup"><span data-stu-id="11fa4-585">If the remote computer isn't in a domain that the local computer trusts, the computer might not be able to authenticate the user's credentials.</span></span> <span data-ttu-id="11fa4-586">Para adicionar o computador remoto à lista de hosts confiáveis no WS-Management, use o seguinte comando no `WSMAN` provedor, em que `<Remote-Computer-Name>` é o nome do computador remoto:</span><span class="sxs-lookup"><span data-stu-id="11fa4-586">To add the remote computer to the list of trusted hosts in WS-Management, use the following command in the `WSMAN` provider, where `<Remote-Computer-Name>` is the name of the remote computer:</span></span>

`Set-Item -Path WSMan:\Localhost\Client\TrustedHosts -Value \<Remote-Computer-Name\>`

<span data-ttu-id="11fa4-587">Quando você desconecta uma **PSSession** usando o parâmetro **InDisconnectedSession** , o estado da sessão é **desconectado** e a disponibilidade é **nenhuma** .</span><span class="sxs-lookup"><span data-stu-id="11fa4-587">When you disconnect a **PSSession** using the **InDisconnectedSession** parameter, the session state is **Disconnected** and the availability is **None** .</span></span> <span data-ttu-id="11fa4-588">O valor da propriedade **State** é relativo a sessão atual.</span><span class="sxs-lookup"><span data-stu-id="11fa4-588">The value of the **State** property is relative to the current session.</span></span> <span data-ttu-id="11fa4-589">Um valor de **desconectado** significa que a **PSSession** não está conectada à sessão atual.</span><span class="sxs-lookup"><span data-stu-id="11fa4-589">A value of **Disconnected** means that the **PSSession** isn't connected to the current session.</span></span> <span data-ttu-id="11fa4-590">No entanto, isso não significa que a **PSSession** seja desconectada de todas as sessões.</span><span class="sxs-lookup"><span data-stu-id="11fa4-590">However, it doesn't mean that the **PSSession** is disconnected from all sessions.</span></span> <span data-ttu-id="11fa4-591">Ela pode ser conectada a uma sessão diferente.</span><span class="sxs-lookup"><span data-stu-id="11fa4-591">It might be connected to a different session.</span></span> <span data-ttu-id="11fa4-592">Para determinar se é possível conectar-se ou reconectar-se à sessão, utilize a propriedade **Availability** .</span><span class="sxs-lookup"><span data-stu-id="11fa4-592">To determine whether you can connect or reconnect to the session, use the **Availability** property.</span></span>

<span data-ttu-id="11fa4-593">Um valor **Availability** de **None** indica que é possível conectar-se à sessão.</span><span class="sxs-lookup"><span data-stu-id="11fa4-593">An **Availability** value of **None** indicates that you can connect to the session.</span></span> <span data-ttu-id="11fa4-594">Um valor de **ocupado** indica que você não pode se conectar à **PSSession** porque ela está conectada a outra sessão.</span><span class="sxs-lookup"><span data-stu-id="11fa4-594">A value of **Busy** indicates that you can't connect to the **PSSession** because it's connected to another session.</span></span> <span data-ttu-id="11fa4-595">Para obter mais informações sobre os valores da propriedade **State** de sessões, consulte [RunspaceState](/dotnet/api/system.management.automation.runspaces.runspacestate).</span><span class="sxs-lookup"><span data-stu-id="11fa4-595">For more information about the values of the **State** property of sessions, see [RunspaceState](/dotnet/api/system.management.automation.runspaces.runspacestate).</span></span> <span data-ttu-id="11fa4-596">Para obter mais informações sobre os valores da propriedade de sessões de **disponibilidade** , consulte [RunspaceAvailability](/dotnet/api/system.management.automation.runspaces.runspaceavailability).</span><span class="sxs-lookup"><span data-stu-id="11fa4-596">For more information about the values of the **Availability** property of sessions, see [RunspaceAvailability](/dotnet/api/system.management.automation.runspaces.runspaceavailability).</span></span>

<span data-ttu-id="11fa4-597">Os parâmetros **hostname** e **SSHConnection** foram incluídos a partir do PowerShell 6,0.</span><span class="sxs-lookup"><span data-stu-id="11fa4-597">The **HostName** and **SSHConnection** parameters were included starting with PowerShell 6.0.</span></span> <span data-ttu-id="11fa4-598">Elas foram adicionadas para fornecer comunicação remota do PowerShell com base em Secure Shell (SSH).</span><span class="sxs-lookup"><span data-stu-id="11fa4-598">They were added to provide PowerShell remoting based on Secure Shell (SSH).</span></span> <span data-ttu-id="11fa4-599">O PowerShell e o SSH têm suporte em várias plataformas (Windows, Linux, macOS) e a comunicação remota do PowerShell funciona nessas plataformas em que o PowerShell e o SSH estão instalados e configurados.</span><span class="sxs-lookup"><span data-stu-id="11fa4-599">PowerShell and SSH are supported on multiple platforms (Windows, Linux, macOS) and PowerShell remoting works over these platforms where PowerShell and SSH are installed and configured.</span></span> <span data-ttu-id="11fa4-600">Isso é separado da somente comunicação remota do Windows anterior que é baseada no WinRM e que muitos dos recursos e limitações específicos do WinRM não se aplicam.</span><span class="sxs-lookup"><span data-stu-id="11fa4-600">This is separate from the previous Windows only remoting that is based on WinRM and many of the WinRM specific features and limitations don't apply.</span></span> <span data-ttu-id="11fa4-601">Por exemplo, cotas baseadas em WinRM, opções de sessão, configuração de ponto de extremidade personalizado e recursos de desconexão/reconexão não têm suporte no momento.</span><span class="sxs-lookup"><span data-stu-id="11fa4-601">For example WinRM based quotas, session options, custom endpoint configuration, and disconnect/reconnect features are currently not supported.</span></span> <span data-ttu-id="11fa4-602">Para obter mais informações sobre como configurar a comunicação remota do PowerShell SSH, consulte [comunicação remota do PowerShell por SSH](/powershell/scripting/learn/remoting/ssh-remoting-in-powershell-core).</span><span class="sxs-lookup"><span data-stu-id="11fa4-602">For more information about how to set up PowerShell SSH remoting, see [PowerShell Remoting Over SSH](/powershell/scripting/learn/remoting/ssh-remoting-in-powershell-core).</span></span>

## <span data-ttu-id="11fa4-603">LINKS RELACIONADOS</span><span class="sxs-lookup"><span data-stu-id="11fa4-603">RELATED LINKS</span></span>

[<span data-ttu-id="11fa4-604">about_PSSessions</span><span class="sxs-lookup"><span data-stu-id="11fa4-604">about_PSSessions</span></span>](./About/about_PSSessions.md)

[<span data-ttu-id="11fa4-605">about_Remote</span><span class="sxs-lookup"><span data-stu-id="11fa4-605">about_Remote</span></span>](./About/about_Remote.md)

[<span data-ttu-id="11fa4-606">about_Remote_Disconnected_Sessions</span><span class="sxs-lookup"><span data-stu-id="11fa4-606">about_Remote_Disconnected_Sessions</span></span>](./About/about_Remote_Disconnected_Sessions.md)

[<span data-ttu-id="11fa4-607">about_Remote_Troubleshooting</span><span class="sxs-lookup"><span data-stu-id="11fa4-607">about_Remote_Troubleshooting</span></span>](./About/about_remote_troubleshooting.md)

[<span data-ttu-id="11fa4-608">about_Remote_Variables</span><span class="sxs-lookup"><span data-stu-id="11fa4-608">about_Remote_Variables</span></span>](./About/about_Remote_Variables.md)

[<span data-ttu-id="11fa4-609">about_Scopes</span><span class="sxs-lookup"><span data-stu-id="11fa4-609">about_Scopes</span></span>](./About/about_scopes.md)

[<span data-ttu-id="11fa4-610">Enter-PSSession</span><span class="sxs-lookup"><span data-stu-id="11fa4-610">Enter-PSSession</span></span>](Enter-PSSession.md)

[<span data-ttu-id="11fa4-611">Exit-PSSession</span><span class="sxs-lookup"><span data-stu-id="11fa4-611">Exit-PSSession</span></span>](Exit-PSSession.md)

[<span data-ttu-id="11fa4-612">Get-PSSession</span><span class="sxs-lookup"><span data-stu-id="11fa4-612">Get-PSSession</span></span>](Get-PSSession.md)

[<span data-ttu-id="11fa4-613">Invoke-Item</span><span class="sxs-lookup"><span data-stu-id="11fa4-613">Invoke-Item</span></span>](../Microsoft.PowerShell.Management/Invoke-Item.md)

[<span data-ttu-id="11fa4-614">New-PSSession</span><span class="sxs-lookup"><span data-stu-id="11fa4-614">New-PSSession</span></span>](New-PSSession.md)

[<span data-ttu-id="11fa4-615">Remove-PSSession</span><span class="sxs-lookup"><span data-stu-id="11fa4-615">Remove-PSSession</span></span>](Remove-PSSession.md)

[<span data-ttu-id="11fa4-616">Provedor WSMan</span><span class="sxs-lookup"><span data-stu-id="11fa4-616">WSMan Provider</span></span>](../Microsoft.WsMan.Management/About/about_WSMan_Provider.md)
