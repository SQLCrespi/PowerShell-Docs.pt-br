...
Este exemplo mostra como construir um pool de runspace remoto e como executar vários comandos simultaneamente usando esse pool.
...
- Executar os cmdlets [Get-Process](/powershell/module/Microsoft.PowerShell.Management/Get-Process) e [Get-Service](/powershell/module/microsoft.powershell.management/get-service) simultaneamente usando o pool de runspace remoto.

- Fechando o pool de runspace remoto para liberar a conexão remota.
