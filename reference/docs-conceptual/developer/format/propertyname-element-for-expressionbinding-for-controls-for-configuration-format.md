...
Especifica a propriedade .NET cujo valor é exibido pelo controle comum. Esse elemento é usado ao definir um controle comum que pode ser usado por todas as exibições no arquivo de formatação.
