...
---
# <a name="enumeratecollection-element-for-expressionbinding-for-controls-for-view-format"></a>Elemento EnumerateCollection para ExpressionBinding para Controls para View (formato)

Especificado que os elementos das coleções são exibidos. Esse elemento é usado ao definir controles que podem ser usados por uma exibição.
...
As seções a seguir descrevem atributos, elementos filho e o elemento pai do elemento `EnumerateCollection`.
