...
---
# <a name="propertyname-element-for-expressionbinding-for-controls-for-view-format"></a>Elemento PropertyName para ExpressionBinding para Controls para View (formato)

Especifica a propriedade .NET cujo valor é exibido pelo controle. Esse elemento é usado ao definir controles que podem ser usados por uma exibição.
