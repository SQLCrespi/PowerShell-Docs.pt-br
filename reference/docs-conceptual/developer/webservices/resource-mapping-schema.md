...
A extensão do IIS do Management OData usa arquivos XML para definir o mapeamento de recursos. O XSD a seguir define o esquema usado para esses arquivos.

## <a name="resource-mapping-file-xsd"></a>XSD do arquivo de mapeamento de recursos

O XSD a seguir define o esquema para arquivos de mapeamento de recursos de extensão do IIS do Management OData.
