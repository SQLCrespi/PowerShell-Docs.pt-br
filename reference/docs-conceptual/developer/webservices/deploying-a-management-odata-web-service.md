...
Depois de concluir todas as etapas necessárias para criar um serviço Web do Management OData, você deve implantá-lo como um aplicativo Web no IIS.
...
Os scripts do Windows PowerShell a seguir demonstram como implantar um serviço Web do Management OData.
