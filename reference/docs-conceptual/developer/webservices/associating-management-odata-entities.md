...
- Um cliente pode solicitar os detalhes de uma categoria sem recuperar seus produtos associados. Por exemplo, a solicitação a seguir obtém detalhes da categoria `food`.
