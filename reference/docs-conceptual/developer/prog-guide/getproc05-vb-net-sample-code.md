...
---
# <a name="getproc05-vbnet-sample-code"></a><span data-ttu-id="9988f-102">Código de exemplo GetProc05 (VB.NET)</span><span class="sxs-lookup"><span data-stu-id="9988f-102">GetProc05 (VB.NET) Sample Code</span></span>

<span data-ttu-id="9988f-103">Aqui está o código completo VB.NET para o cmdlet de exemplo GetProc05.</span><span class="sxs-lookup"><span data-stu-id="9988f-103">Here is the complete VB.NET code for the GetProc05 sample cmdlet.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="9988f-104">Consulte Também</span><span class="sxs-lookup"><span data-stu-id="9988f-104">See Also</span></span>

[<span data-ttu-id="9988f-105">SDK do Windows PowerShell</span><span class="sxs-lookup"><span data-stu-id="9988f-105">Windows PowerShell SDK</span></span>](../windows-powershell-reference.md)