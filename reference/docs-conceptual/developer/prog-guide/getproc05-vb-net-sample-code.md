...
ms.locfileid: "72366655"
---
# <a name="getproc05-vbnet-sample-code"></a><span data-ttu-id="d71a9-102">Código de exemplo GetProc05 (VB.NET)</span><span class="sxs-lookup"><span data-stu-id="d71a9-102">GetProc05 (VB.NET) Sample Code</span></span>

<span data-ttu-id="d71a9-103">Aqui está o código completo VB.NET para o cmdlet de exemplo GetProc05.</span><span class="sxs-lookup"><span data-stu-id="d71a9-103">Here is the complete VB.NET code for the GetProc05 sample cmdlet.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="d71a9-104">Consulte Também</span><span class="sxs-lookup"><span data-stu-id="d71a9-104">See Also</span></span>

[<span data-ttu-id="d71a9-105">SDK do Windows PowerShell</span><span class="sxs-lookup"><span data-stu-id="d71a9-105">Windows PowerShell SDK</span></span>](../windows-powershell-reference.md)