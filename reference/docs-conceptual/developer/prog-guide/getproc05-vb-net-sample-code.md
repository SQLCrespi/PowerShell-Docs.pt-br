...
ms.date: 09/13/2016
ms.topic: reference
title: Código de exemplo GetProc05 (VB.NET)
description: Código de exemplo GetProc05 (VB.NET)
ms.openlocfilehash: 6860a8276fd691562ae7e2cbbd95d199ee93fd71
ms.sourcegitcommit: ba7315a496986451cfc1296b659d73ea2373d3f0
ms.translationtype: MT
ms.contentlocale: pt-BR
ms.lasthandoff: 12/10/2020
ms.locfileid: "92653873"
---
# <a name="getproc05-vbnet-sample-code"></a><span data-ttu-id="d9ef0-103">Código de exemplo GetProc05 (VB.NET)</span><span class="sxs-lookup"><span data-stu-id="d9ef0-103">GetProc05 (VB.NET) Sample Code</span></span>

<span data-ttu-id="d9ef0-104">Aqui está o código completo VB.NET para o cmdlet de exemplo GetProc05.</span><span class="sxs-lookup"><span data-stu-id="d9ef0-104">Here is the complete VB.NET code for the GetProc05 sample cmdlet.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="d9ef0-105">Consulte Também</span><span class="sxs-lookup"><span data-stu-id="d9ef0-105">See Also</span></span>

[<span data-ttu-id="d9ef0-106">SDK do Windows PowerShell</span><span class="sxs-lookup"><span data-stu-id="d9ef0-106">Windows PowerShell SDK</span></span>](../windows-powershell-reference.md)
