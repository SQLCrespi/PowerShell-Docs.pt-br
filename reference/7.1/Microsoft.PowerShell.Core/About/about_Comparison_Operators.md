...
> [!WARNING]
> Como o `$` caractere é usado na expansão da cadeia de caracteres, você deverá usar as cadeias de caracteres literais ou escapar o `$` caractere.
>
> ```powershell
...
A partir do PowerShell 6, você pode usar um argumento **scriptblock** para o texto de _substituição_ . O **scriptblock** será executado para cada correspondência encontrada na cadeia de caracteres de _entrada_ .
