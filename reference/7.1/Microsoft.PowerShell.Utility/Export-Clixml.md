...
A cadeia de caracteres `This is a test` é enviada pelo pipeline. `Export-Clixml` usa o parâmetro **path** para criar um arquivo XML chamado `sample.xml` no diretório atual.
