...
**Stream** é um parâmetro dinâmico que o provedor FileSystem adiciona `Clear-Content` . Esse parâmetro funciona apenas em unidades do sistema de arquivos e limpará o conteúdo de fluxos de dados alternativos em arquivos e diretórios.
...
Esse parâmetro foi introduzido no PowerShell 3,0. A partir do PowerShell 7,2, `Clear-Content` o pode limpar o conteúdo de fluxos de dados alternativos de diretórios, bem como arquivos.
