...
Especifica os caminhos que serão resolvidos.
O valor do parâmetro **LiteralPath** é usado exatamente como tipado.
...
Também é possível canalizar uma cadeia de caracteres de caminho para `Resolve-Path` .
...
É possível canalizar uma cadeia de caracteres que contém um caminho para este cmdlet
