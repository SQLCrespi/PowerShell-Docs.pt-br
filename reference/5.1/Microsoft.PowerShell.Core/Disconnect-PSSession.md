...
O Gerenciador faz logon em seu computador doméstico, conecta-se à sua rede corporativa, inicia o Windows PowerShell e usa o `Get-PSSession` cmdlet para obter a sessão ITTask no computador Srv1. Ele usa as credenciais do técnico para acessar a sessão.
