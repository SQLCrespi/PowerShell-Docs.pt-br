...
### <span data-ttu-id="a86eb-109">FilePathRunspace</span><span class="sxs-lookup"><span data-stu-id="a86eb-109">FilePathRunspace</span></span>
...
### <span data-ttu-id="a86eb-114">VMId</span><span class="sxs-lookup"><span data-stu-id="a86eb-114">VMId</span></span>
...
## <span data-ttu-id="a86eb-120">DESCRIPTION</span><span class="sxs-lookup"><span data-stu-id="a86eb-120">DESCRIPTION</span></span>
...
<span data-ttu-id="a86eb-134">Este exemplo executa o `Test.ps1` script no computador Server01.</span><span class="sxs-lookup"><span data-stu-id="a86eb-134">This example runs the `Test.ps1` script on the Server01 computer.</span></span>
...
<span data-ttu-id="a86eb-157">Quando você usa o parâmetro **ComputerName** , o PowerShell cria uma nova sessão para executar o comando.</span><span class="sxs-lookup"><span data-stu-id="a86eb-157">When you use the **ComputerName** parameter, PowerShell creates a new session to run the command.</span></span>
...
### <span data-ttu-id="a86eb-169">Exemplo 6: executar um único comando em vários computadores</span><span class="sxs-lookup"><span data-stu-id="a86eb-169">Example 6: Run a single command on several computers</span></span>
...
<span data-ttu-id="a86eb-180">O `Invoke-Command` cmdlet executa um `Get-Host` comando nos computadores remotos.</span><span class="sxs-lookup"><span data-stu-id="a86eb-180">The `Invoke-Command` cmdlet runs a `Get-Host` command on the remote computers.</span></span> <span data-ttu-id="a86eb-181">Ele usa a notação de ponto para obter a propriedade **version** do host do PowerShell.</span><span class="sxs-lookup"><span data-stu-id="a86eb-181">It uses dot notation to get the **Version** property of the PowerShell host.</span></span>
...
### <span data-ttu-id="a86eb-222">Exemplo 12: usar a $args variável automática em um bloco de script</span><span class="sxs-lookup"><span data-stu-id="a86eb-222">Example 12: Use the $args automatic variable in a script block</span></span>
...
<span data-ttu-id="a86eb-230">Este exemplo usa o `Invoke-Command` cmdlet para executar o `Sample.ps1` script em todos os computadores listados no `Servers.txt` arquivo.</span><span class="sxs-lookup"><span data-stu-id="a86eb-230">This example uses the `Invoke-Command` cmdlet to run the `Sample.ps1` script on all the computers listed in the `Servers.txt` file.</span></span> <span data-ttu-id="a86eb-231">O comando usa o parâmetro **FilePath** para especificar o arquivo de script.</span><span class="sxs-lookup"><span data-stu-id="a86eb-231">The command uses the **FilePath** parameter to specify the script file.</span></span> <span data-ttu-id="a86eb-232">Esse comando permite que você execute o script nos computadores remotos, mesmo que o arquivo de script não esteja acessível para os computadores remotos.</span><span class="sxs-lookup"><span data-stu-id="a86eb-232">This command lets you run the script on the remote computers, even if the script file isn't accessible to the remote computers.</span></span>
...
### <span data-ttu-id="a86eb-253">Exemplo 16: gerenciar o redirecionamento de URI em um comando remoto</span><span class="sxs-lookup"><span data-stu-id="a86eb-253">Example 16: Manage URI redirection in a remote command</span></span>
...
<span data-ttu-id="a86eb-287">O valor de **SessionOption** é uma tabela de hash.</span><span class="sxs-lookup"><span data-stu-id="a86eb-287">The value of **SessionOption** is a hash table.</span></span> <span data-ttu-id="a86eb-288">O valor de **OutputBufferingMode** é definido como **drop** e o valor de **IdleTimeout** é definido como **43,2 milhões** milissegundos (12 horas).</span><span class="sxs-lookup"><span data-stu-id="a86eb-288">The **OutputBufferingMode** value is set to **Drop** and the **IdleTimeout** value is set to **43200000** milliseconds (12 hours).</span></span>
...
### <span data-ttu-id="a86eb-298">-ApplicationName</span><span class="sxs-lookup"><span data-stu-id="a86eb-298">-ApplicationName</span></span>
...
<span data-ttu-id="a86eb-341">O valor padrão é Default.</span><span class="sxs-lookup"><span data-stu-id="a86eb-341">The default value is Default.</span></span>
...
### <span data-ttu-id="a86eb-373">-Conexãouri</span><span class="sxs-lookup"><span data-stu-id="a86eb-373">-ConnectionUri</span></span>
...
### <span data-ttu-id="a86eb-383">-ContainerId</span><span class="sxs-lookup"><span data-stu-id="a86eb-383">-ContainerId</span></span>
...
### <span data-ttu-id="a86eb-392">-EnableNetworkAccess</span><span class="sxs-lookup"><span data-stu-id="a86eb-392">-EnableNetworkAccess</span></span>
...
<span data-ttu-id="a86eb-405">Esse parâmetro foi introduzido no PowerShell 3,0.</span><span class="sxs-lookup"><span data-stu-id="a86eb-405">This parameter was introduced in PowerShell 3.0.</span></span>
...
<span data-ttu-id="a86eb-411">Quando você usa esse parâmetro, o PowerShell converte o conteúdo do arquivo de script especificado em um bloco de script, transmite o bloco de script para o computador remoto e o executa no computador remoto.</span><span class="sxs-lookup"><span data-stu-id="a86eb-411">When you use this parameter, PowerShell converts the contents of the specified script file to a script block, transmits the script block to the remote computer, and runs it on the remote computer.</span></span>
...
### <span data-ttu-id="a86eb-412">-HideComputerName</span><span class="sxs-lookup"><span data-stu-id="a86eb-412">-HideComputerName</span></span>

<span data-ttu-id="a86eb-413">Indica que esse cmdlet omite o nome do computador de cada objeto da exibição de saída.</span><span class="sxs-lookup"><span data-stu-id="a86eb-413">Indicates that this cmdlet omits the computer name of each object from the output display.</span></span> <span data-ttu-id="a86eb-414">Por padrão, o nome do computador que gerou o objeto aparece na exibição.</span><span class="sxs-lookup"><span data-stu-id="a86eb-414">By default, the name of the computer that generated the object appears in the display.</span></span>

<span data-ttu-id="a86eb-415">Este parâmetro afeta somente a exibição de saída.</span><span class="sxs-lookup"><span data-stu-id="a86eb-415">This parameter affects only the output display.</span></span> <span data-ttu-id="a86eb-416">Ele não altera o objeto.</span><span class="sxs-lookup"><span data-stu-id="a86eb-416">It doesn't change the object.</span></span>
...
### <span data-ttu-id="a86eb-417">-InDisconnectedSession</span><span class="sxs-lookup"><span data-stu-id="a86eb-417">-InDisconnectedSession</span></span>

<span data-ttu-id="a86eb-418">Indica que este cmdlet executa um comando ou script em uma sessão desconectada.</span><span class="sxs-lookup"><span data-stu-id="a86eb-418">Indicates that this cmdlet runs a command or script in a disconnected session.</span></span>

<span data-ttu-id="a86eb-419">Quando você usa o parâmetro **InDisconnectedSession** , o `Invoke-Command` cria uma sessão persistente em cada computador remoto, inicia o comando especificado pelo parâmetro **scriptblock** ou **FilePath** e, em seguida, desconecta-se da sessão.</span><span class="sxs-lookup"><span data-stu-id="a86eb-419">When you use the **InDisconnectedSession** parameter, `Invoke-Command` creates a persistent session on each remote computer, starts the command specified by the **ScriptBlock** or **FilePath** parameter, and then disconnects from the session.</span></span> <span data-ttu-id="a86eb-420">Os comandos continuam a ser executados nas sessões desconectadas.</span><span class="sxs-lookup"><span data-stu-id="a86eb-420">The commands continue to run in the disconnected sessions.</span></span> <span data-ttu-id="a86eb-421">O **InDisconnectedSession** permite que você execute comandos sem manter uma conexão com as sessões remotas.</span><span class="sxs-lookup"><span data-stu-id="a86eb-421">**InDisconnectedSession** enables you to run commands without maintaining a connection to the remote sessions.</span></span> <span data-ttu-id="a86eb-422">E, como a sessão é desconectada antes de qualquer resultado ser retornado, o **InDisconnectedSession** garante que todos os resultados de comando sejam retornados para a sessão reconectada, em vez de serem divididos entre as sessões.</span><span class="sxs-lookup"><span data-stu-id="a86eb-422">And, because the session is disconnected before any results are returned, **InDisconnectedSession** makes sure that all command results are returned to the reconnected session, instead of being split between sessions.</span></span>

<span data-ttu-id="a86eb-423">Você não pode usar **InDisconnectedSession** com o parâmetro **Session** ou o parâmetro **AsJob** .</span><span class="sxs-lookup"><span data-stu-id="a86eb-423">You can't use **InDisconnectedSession** with the **Session** parameter or the **AsJob** parameter.</span></span>

<span data-ttu-id="a86eb-424">Comandos que usam **InDisconnectedSession** retornam um objeto **PSSession** que representa a sessão desconectada.</span><span class="sxs-lookup"><span data-stu-id="a86eb-424">Commands that use **InDisconnectedSession** return a **PSSession** object that represents the disconnected session.</span></span> <span data-ttu-id="a86eb-425">Eles não retornam a saída do comando.</span><span class="sxs-lookup"><span data-stu-id="a86eb-425">They don't return the command output.</span></span> <span data-ttu-id="a86eb-426">Para se conectar à sessão desconectada, use os `Connect-PSSession` `Receive-PSSession` cmdlets ou.</span><span class="sxs-lookup"><span data-stu-id="a86eb-426">To connect to the disconnected session, use the `Connect-PSSession` or `Receive-PSSession` cmdlets.</span></span> <span data-ttu-id="a86eb-427">Para obter os resultados dos comandos que foram executados na sessão, use o `Receive-PSSession` cmdlet.</span><span class="sxs-lookup"><span data-stu-id="a86eb-427">To get the results of commands that ran in the session, use the `Receive-PSSession` cmdlet.</span></span> <span data-ttu-id="a86eb-428">Para executar comandos que geram saída em uma sessão desconectada, defina o valor da opção de sessão **OutputBufferingMode** como **drop** .</span><span class="sxs-lookup"><span data-stu-id="a86eb-428">To run commands that generate output in a disconnected session, set the value of the **OutputBufferingMode** session option to **Drop** .</span></span> <span data-ttu-id="a86eb-429">Se você pretende se conectar à sessão desconectada, defina o tempo limite ocioso na sessão para que ela forneça tempo suficiente para que você se conecte antes de excluir a sessão.</span><span class="sxs-lookup"><span data-stu-id="a86eb-429">If you intend to connect to the disconnected session, set the idle time-out in the session so that it provides sufficient time for you to connect before deleting the session.</span></span>

<span data-ttu-id="a86eb-430">Você pode definir o modo de buffer de saída e o tempo limite ocioso no parâmetro **SessionOption** ou na `$PSSessionOption` variável de preferência.</span><span class="sxs-lookup"><span data-stu-id="a86eb-430">You can set the output buffering mode and idle time-out in the **SessionOption** parameter or in the `$PSSessionOption` preference variable.</span></span> <span data-ttu-id="a86eb-431">Para obter mais informações sobre as opções de sessão, consulte `New-PSSessionOption` e [about_Preference_Variables](./about/about_preference_variables.md).</span><span class="sxs-lookup"><span data-stu-id="a86eb-431">For more information about session options, see `New-PSSessionOption` and [about_Preference_Variables](./about/about_preference_variables.md).</span></span>

<span data-ttu-id="a86eb-432">Para obter mais informações sobre o recurso de Sessões desconectadas, consulte [about_Remote_Disconnected_Sessions](about/about_Remote_Disconnected_Sessions.md).</span><span class="sxs-lookup"><span data-stu-id="a86eb-432">For more information about the Disconnected Sessions feature, see [about_Remote_Disconnected_Sessions](about/about_Remote_Disconnected_Sessions.md).</span></span>

<span data-ttu-id="a86eb-433">Esse parâmetro foi introduzido no PowerShell 3,0.</span><span class="sxs-lookup"><span data-stu-id="a86eb-433">This parameter was introduced in PowerShell 3.0.</span></span>
...
### <span data-ttu-id="a86eb-434">-InputObject</span><span class="sxs-lookup"><span data-stu-id="a86eb-434">-InputObject</span></span>

<span data-ttu-id="a86eb-435">Especifica a entrada para o comando.</span><span class="sxs-lookup"><span data-stu-id="a86eb-435">Specifies input to the command.</span></span> <span data-ttu-id="a86eb-436">Insira uma variável que contém os objetos ou digite um comando ou uma expressão que obtém os objetos.</span><span class="sxs-lookup"><span data-stu-id="a86eb-436">Enter a variable that contains the objects or type a command or expression that gets the objects.</span></span>

<span data-ttu-id="a86eb-437">Ao usar o parâmetro **InputObject** , use a `$Input` variável automática no valor do parâmetro **scriptblock** para representar os objetos de entrada.</span><span class="sxs-lookup"><span data-stu-id="a86eb-437">When using the **InputObject** parameter, use the `$Input` automatic variable in the value of the **ScriptBlock** parameter to represent the input objects.</span></span>
...
### <span data-ttu-id="a86eb-438">-JobName</span><span class="sxs-lookup"><span data-stu-id="a86eb-438">-JobName</span></span>

<span data-ttu-id="a86eb-439">Especifica um nome amigável para o trabalho em segundo plano.</span><span class="sxs-lookup"><span data-stu-id="a86eb-439">Specifies a friendly name for the background job.</span></span> <span data-ttu-id="a86eb-440">Por padrão, os trabalhos são nomeados `Job<n>` , em que `<n>` é um número ordinal.</span><span class="sxs-lookup"><span data-stu-id="a86eb-440">By default, jobs are named `Job<n>`, where `<n>` is an ordinal number.</span></span>

<span data-ttu-id="a86eb-441">Se você usar o parâmetro **JobName** em um comando, o comando será executado como um trabalho e `Invoke-Command` retornará um objeto de trabalho, mesmo que você não inclua **AsJob** no comando.</span><span class="sxs-lookup"><span data-stu-id="a86eb-441">If you use the **JobName** parameter in a command, the command is run as a job, and `Invoke-Command` returns a job object, even if you don't include **AsJob** in the command.</span></span>

<span data-ttu-id="a86eb-442">Para obter mais informações sobre trabalhos em segundo plano do PowerShell, consulte [about_Jobs](./About/about_Jobs.md).</span><span class="sxs-lookup"><span data-stu-id="a86eb-442">For more information about PowerShell background jobs, see [about_Jobs](./About/about_Jobs.md).</span></span>
...
### <span data-ttu-id="a86eb-443">-NoNewScope</span><span class="sxs-lookup"><span data-stu-id="a86eb-443">-NoNewScope</span></span>

<span data-ttu-id="a86eb-444">Indica que esse cmdlet executa o comando especificado no escopo atual.</span><span class="sxs-lookup"><span data-stu-id="a86eb-444">Indicates that this cmdlet runs the specified command in the current scope.</span></span> <span data-ttu-id="a86eb-445">Por padrão, `Invoke-Command` o executa comandos em seu próprio escopo.</span><span class="sxs-lookup"><span data-stu-id="a86eb-445">By default, `Invoke-Command` runs commands in their own scope.</span></span>

<span data-ttu-id="a86eb-446">Esse parâmetro é válido somente em comandos que são executados na sessão atual, ou seja, comandos que omitem ambos os parâmetros **ComputerName** e **Session** .</span><span class="sxs-lookup"><span data-stu-id="a86eb-446">This parameter is valid only in commands that are run in the current session, that is, commands that omit both the **ComputerName** and **Session** parameters.</span></span>

<span data-ttu-id="a86eb-447">Esse parâmetro foi introduzido no PowerShell 3,0.</span><span class="sxs-lookup"><span data-stu-id="a86eb-447">This parameter was introduced in PowerShell 3.0.</span></span>
...
### <span data-ttu-id="a86eb-448">-Port</span><span class="sxs-lookup"><span data-stu-id="a86eb-448">-Port</span></span>

<span data-ttu-id="a86eb-449">Especifica a porta de rede no computador remoto que é usada para este comando.</span><span class="sxs-lookup"><span data-stu-id="a86eb-449">Specifies the network port on the remote computer that is used for this command.</span></span> <span data-ttu-id="a86eb-450">Para se conectar a um computador remoto, este deve estar escutando na porta usada pela conexão.</span><span class="sxs-lookup"><span data-stu-id="a86eb-450">To connect to a remote computer, the remote computer must be listening on the port that the connection uses.</span></span> <span data-ttu-id="a86eb-451">As portas padrão são 5985 (porta do WinRM para HTTP) e 5986 (porta do WinRM para HTTPS).</span><span class="sxs-lookup"><span data-stu-id="a86eb-451">The default ports are 5985 (WinRM port for HTTP) and 5986 (WinRM port for HTTPS).</span></span>

<span data-ttu-id="a86eb-452">Antes de usar uma porta alternativa, configure o ouvinte WinRM no computador remoto para escutar na porta.</span><span class="sxs-lookup"><span data-stu-id="a86eb-452">Before using an alternate port, configure the WinRM listener on the remote computer to listen at that port.</span></span> <span data-ttu-id="a86eb-453">Para configurar o ouvinte, digite os dois comandos a seguir no prompt do PowerShell:</span><span class="sxs-lookup"><span data-stu-id="a86eb-453">To configure the listener, type the following two commands at the PowerShell prompt:</span></span>

`Remove-Item -Path WSMan:\Localhost\listener\listener* -Recurse`

`New-Item -Path WSMan:\Localhost\listener -Transport http -Address * -Port \<port-number\>`

<span data-ttu-id="a86eb-454">Não use o parâmetro **Port** , a menos que você precise.</span><span class="sxs-lookup"><span data-stu-id="a86eb-454">Don't use the **Port** parameter unless you must.</span></span> <span data-ttu-id="a86eb-455">A porta que está definida no comando se aplica a todos os computadores ou sessões em que o comando é executado.</span><span class="sxs-lookup"><span data-stu-id="a86eb-455">The port that is set in the command applies to all computers or sessions on which the command runs.</span></span> <span data-ttu-id="a86eb-456">Uma configuração de porta alternativa pode impedir que o comando seja executado em todos os computadores.</span><span class="sxs-lookup"><span data-stu-id="a86eb-456">An alternate port setting might prevent the command from running on all computers.</span></span>
...
### <span data-ttu-id="a86eb-457">-RunAsAdministrator</span><span class="sxs-lookup"><span data-stu-id="a86eb-457">-RunAsAdministrator</span></span>

<span data-ttu-id="a86eb-458">Indica que esse cmdlet invoca um comando como administrador.</span><span class="sxs-lookup"><span data-stu-id="a86eb-458">Indicates that this cmdlet invokes a command as an Administrator.</span></span>
...
### <span data-ttu-id="a86eb-459">-ScriptBlock</span><span class="sxs-lookup"><span data-stu-id="a86eb-459">-ScriptBlock</span></span>

<span data-ttu-id="a86eb-460">Especifica os comandos a serem executados.</span><span class="sxs-lookup"><span data-stu-id="a86eb-460">Specifies the commands to run.</span></span> <span data-ttu-id="a86eb-461">Coloque os comandos entre chaves `{ }` para criar um bloco de script.</span><span class="sxs-lookup"><span data-stu-id="a86eb-461">Enclose the commands in curly braces `{ }` to create a script block.</span></span>
<span data-ttu-id="a86eb-462">Este parâmetro é necessário.</span><span class="sxs-lookup"><span data-stu-id="a86eb-462">This parameter is required.</span></span>

<span data-ttu-id="a86eb-463">Por padrão, todas as variáveis no comando são avaliadas no computador remoto.</span><span class="sxs-lookup"><span data-stu-id="a86eb-463">By default, any variables in the command are evaluated on the remote computer.</span></span> <span data-ttu-id="a86eb-464">Para incluir variáveis locais no comando, use **ArgumentList** .</span><span class="sxs-lookup"><span data-stu-id="a86eb-464">To include local variables in the command, use **ArgumentList** .</span></span>
...
### <span data-ttu-id="a86eb-465">-Sessão</span><span class="sxs-lookup"><span data-stu-id="a86eb-465">-Session</span></span>

<span data-ttu-id="a86eb-466">Especifica uma matriz de sessões em que esse cmdlet executa o comando.</span><span class="sxs-lookup"><span data-stu-id="a86eb-466">Specifies an array of sessions in which this cmdlet runs the command.</span></span> <span data-ttu-id="a86eb-467">Insira uma variável que contenha objetos **PSSession** ou um comando que cria ou obtém os objetos **PSSession** , como um `New-PSSession` `Get-PSSession` comando ou.</span><span class="sxs-lookup"><span data-stu-id="a86eb-467">Enter a variable that contains **PSSession** objects or a command that creates or gets the **PSSession** objects, such as a `New-PSSession` or `Get-PSSession` command.</span></span>

<span data-ttu-id="a86eb-468">Quando você cria uma **PSSession** , o PowerShell estabelece uma conexão persistente com o computador remoto.</span><span class="sxs-lookup"><span data-stu-id="a86eb-468">When you create a **PSSession** , PowerShell establishes a persistent connection to the remote computer.</span></span> <span data-ttu-id="a86eb-469">Use uma **PSSession** para executar uma série de comandos relacionados que compartilham dados.</span><span class="sxs-lookup"><span data-stu-id="a86eb-469">Use a **PSSession** to run a series of related commands that share data.</span></span> <span data-ttu-id="a86eb-470">Para executar um único comando ou uma série de comandos não relacionados, use o parâmetro **ComputerName** .</span><span class="sxs-lookup"><span data-stu-id="a86eb-470">To run a single command or a series of unrelated commands, use the **ComputerName** parameter.</span></span> <span data-ttu-id="a86eb-471">Para obter mais informações, consulte [about_PSSessions](./About/about_PSSessions.md).</span><span class="sxs-lookup"><span data-stu-id="a86eb-471">For more information, see [about_PSSessions](./About/about_PSSessions.md).</span></span>
...
### <span data-ttu-id="a86eb-472">-SESSIONNAME</span><span class="sxs-lookup"><span data-stu-id="a86eb-472">-SessionName</span></span>

<span data-ttu-id="a86eb-473">Especifica um nome amigável para uma sessão desconectada.</span><span class="sxs-lookup"><span data-stu-id="a86eb-473">Specifies a friendly name for a disconnected session.</span></span> <span data-ttu-id="a86eb-474">Você pode usar o nome para fazer referência à sessão em comandos subsequentes, como um `Get-PSSession` comando.</span><span class="sxs-lookup"><span data-stu-id="a86eb-474">You can use the name to refer to the session in subsequent commands, such as a `Get-PSSession` command.</span></span> <span data-ttu-id="a86eb-475">Esse parâmetro é válido somente com o parâmetro **InDisconnectedSession** .</span><span class="sxs-lookup"><span data-stu-id="a86eb-475">This parameter is valid only with the **InDisconnectedSession** parameter.</span></span>

<span data-ttu-id="a86eb-476">Esse parâmetro foi introduzido no PowerShell 3,0.</span><span class="sxs-lookup"><span data-stu-id="a86eb-476">This parameter was introduced in PowerShell 3.0.</span></span>
...
### <span data-ttu-id="a86eb-477">-SessionOption</span><span class="sxs-lookup"><span data-stu-id="a86eb-477">-SessionOption</span></span>

<span data-ttu-id="a86eb-478">Especifica as opções avançadas para a sessão.</span><span class="sxs-lookup"><span data-stu-id="a86eb-478">Specifies advanced options for the session.</span></span> <span data-ttu-id="a86eb-479">Insira um objeto **SessionOption** , como um que você cria usando o `New-PSSessionOption` cmdlet ou uma tabela de hash na qual as chaves são nomes de opção de sessão e os valores são valores de opção de sessão.</span><span class="sxs-lookup"><span data-stu-id="a86eb-479">Enter a **SessionOption** object, such as one that you create using the `New-PSSessionOption` cmdlet, or a hash table in which the keys are session option names and the values are session option values.</span></span>

<span data-ttu-id="a86eb-480">Os valores padrão para as opções são determinados pelo valor da variável de `$PSSessionOption` preferência, se ele estiver definido.</span><span class="sxs-lookup"><span data-stu-id="a86eb-480">The default values for the options are determined by the value of the `$PSSessionOption` preference variable, if it's set.</span></span> <span data-ttu-id="a86eb-481">Caso contrário, os valores padrão são estabelecidos por opções definidas na configuração da sessão.</span><span class="sxs-lookup"><span data-stu-id="a86eb-481">Otherwise, the default values are established by options set in the session configuration.</span></span>

<span data-ttu-id="a86eb-482">Os valores de opção de sessão têm precedência sobre valores padrão para sessões definidas na `$PSSessionOption` variável de preferência e na configuração da sessão.</span><span class="sxs-lookup"><span data-stu-id="a86eb-482">The session option values take precedence over default values for sessions set in the `$PSSessionOption` preference variable and in the session configuration.</span></span> <span data-ttu-id="a86eb-483">No entanto, eles não têm precedência sobre os valores máximos, cotas ou limites definidos na configuração da sessão.</span><span class="sxs-lookup"><span data-stu-id="a86eb-483">However, they don't take precedence over maximum values, quotas, or limits set in the session configuration.</span></span>

<span data-ttu-id="a86eb-484">Para obter uma descrição das opções de sessão que incluem os valores padrão, consulte `New-PSSessionOption` .</span><span class="sxs-lookup"><span data-stu-id="a86eb-484">For a description of the session options that includes the default values, see `New-PSSessionOption`.</span></span> <span data-ttu-id="a86eb-485">Para obter informações sobre a `$PSSessionOption` variável de preferência, consulte [about_Preference_Variables](About/about_Preference_Variables.md).</span><span class="sxs-lookup"><span data-stu-id="a86eb-485">For information about the `$PSSessionOption` preference variable, see [about_Preference_Variables](About/about_Preference_Variables.md).</span></span>
<span data-ttu-id="a86eb-486">Para obter mais informações sobre configurações de sessão, consulte [about_Session_Configurations](About/about_Session_Configurations.md).</span><span class="sxs-lookup"><span data-stu-id="a86eb-486">For more information about session configurations, see [about_Session_Configurations](About/about_Session_Configurations.md).</span></span>
...
### <span data-ttu-id="a86eb-487">-ThrottleLimit</span><span class="sxs-lookup"><span data-stu-id="a86eb-487">-ThrottleLimit</span></span>

<span data-ttu-id="a86eb-488">Especifica o número máximo de conexões simultâneas que podem ser estabelecidas para executar o comando.</span><span class="sxs-lookup"><span data-stu-id="a86eb-488">Specifies the maximum number of concurrent connections that can be established to run this command.</span></span>
<span data-ttu-id="a86eb-489">Se você omite esse parâmetro ou digita um valor 0, o valor padrão, 32, é usado.</span><span class="sxs-lookup"><span data-stu-id="a86eb-489">If you omit this parameter or enter a value of 0, the default value, 32, is used.</span></span>

<span data-ttu-id="a86eb-490">O limite de aceleração aplica-se somente ao comando atual e não à sessão ou ao computador.</span><span class="sxs-lookup"><span data-stu-id="a86eb-490">The throttle limit applies only to the current command, not to the session or to the computer.</span></span>
...
### <span data-ttu-id="a86eb-491">-UseSSL</span><span class="sxs-lookup"><span data-stu-id="a86eb-491">-UseSSL</span></span>

<span data-ttu-id="a86eb-492">Indica que esse cmdlet usa o protocolo protocolo SSL (SSL) para estabelecer uma conexão com o computador remoto.</span><span class="sxs-lookup"><span data-stu-id="a86eb-492">Indicates that this cmdlet uses the Secure Sockets Layer (SSL) protocol to establish a connection to the remote computer.</span></span> <span data-ttu-id="a86eb-493">Por padrão, o SSL não é usado.</span><span class="sxs-lookup"><span data-stu-id="a86eb-493">By default, SSL isn't used.</span></span>

<span data-ttu-id="a86eb-494">WS-Management criptografa todo o conteúdo do PowerShell transmitido pela rede.</span><span class="sxs-lookup"><span data-stu-id="a86eb-494">WS-Management encrypts all PowerShell content transmitted over the network.</span></span> <span data-ttu-id="a86eb-495">O parâmetro **UseSSL** é uma proteção adicional que envia os dados por um https, em vez de http.</span><span class="sxs-lookup"><span data-stu-id="a86eb-495">The **UseSSL** parameter is an additional protection that sends the data across an HTTPS, instead of HTTP.</span></span>

<span data-ttu-id="a86eb-496">Se você usar esse parâmetro, mas o SSL não estiver disponível na porta usada para o comando, o comando falhará.</span><span class="sxs-lookup"><span data-stu-id="a86eb-496">If you use this parameter, but SSL isn't available on the port that's used for the command, the command fails.</span></span>
...
### <span data-ttu-id="a86eb-497">-VMId</span><span class="sxs-lookup"><span data-stu-id="a86eb-497">-VMId</span></span>

<span data-ttu-id="a86eb-498">Especifica uma matriz de IDs de máquinas virtuais.</span><span class="sxs-lookup"><span data-stu-id="a86eb-498">Specifies an array of IDs of virtual machines.</span></span>
...
### <span data-ttu-id="a86eb-499">-VMName</span><span class="sxs-lookup"><span data-stu-id="a86eb-499">-VMName</span></span>

<span data-ttu-id="a86eb-500">Especifica uma matriz de nomes de máquinas virtuais.</span><span class="sxs-lookup"><span data-stu-id="a86eb-500">Specifies an array of names of virtual machines.</span></span>
...
### <span data-ttu-id="a86eb-501">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="a86eb-501">CommonParameters</span></span>

<span data-ttu-id="a86eb-502">Este cmdlet oferece suporte aos parâmetros comuns: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction e -WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="a86eb-502">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="a86eb-503">Para obter mais informações, confira [about_CommonParameters](https://go.microsoft.com/fwlink/?LinkID=113216).</span><span class="sxs-lookup"><span data-stu-id="a86eb-503">For more information, see [about_CommonParameters](https://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="a86eb-504">ENTRADAS</span><span class="sxs-lookup"><span data-stu-id="a86eb-504">INPUTS</span></span>

### <span data-ttu-id="a86eb-505">System. Management. Automation. ScriptBlock</span><span class="sxs-lookup"><span data-stu-id="a86eb-505">System.Management.Automation.ScriptBlock</span></span>

<span data-ttu-id="a86eb-506">É possível canalizar um comando em um bloco de script para `Invoke-Command` .</span><span class="sxs-lookup"><span data-stu-id="a86eb-506">You can pipe a command in a script block to `Invoke-Command`.</span></span> <span data-ttu-id="a86eb-507">Use a `$Input` variável automática para representar os objetos de entrada no comando.</span><span class="sxs-lookup"><span data-stu-id="a86eb-507">Use the `$Input` automatic variable to represent the input objects in the command.</span></span>

## <span data-ttu-id="a86eb-508">SAÍDAS</span><span class="sxs-lookup"><span data-stu-id="a86eb-508">OUTPUTS</span></span>

### <span data-ttu-id="a86eb-509">System. Management. Automation. PSRemotingJob, System. Management. Automation. Runspaces. PSSession ou a saída do comando invocado</span><span class="sxs-lookup"><span data-stu-id="a86eb-509">System.Management.Automation.PSRemotingJob, System.Management.Automation.Runspaces.PSSession, or the output of the invoked command</span></span>

<span data-ttu-id="a86eb-510">Esse cmdlet retorna um objeto de trabalho, se você usar o parâmetro **AsJob** .</span><span class="sxs-lookup"><span data-stu-id="a86eb-510">This cmdlet returns a job object, if you use the **AsJob** parameter.</span></span> <span data-ttu-id="a86eb-511">Se você especificar o parâmetro **InDisconnectedSession** , `Invoke-Command` retornará um objeto **PSSession** .</span><span class="sxs-lookup"><span data-stu-id="a86eb-511">If you specify the **InDisconnectedSession** parameter, `Invoke-Command` returns a **PSSession** object.</span></span> <span data-ttu-id="a86eb-512">Caso contrário, ele retorna a saída do comando invocado, que é o valor do parâmetro **scriptblock** .</span><span class="sxs-lookup"><span data-stu-id="a86eb-512">Otherwise, it returns the output of the invoked command, which is the value of the **ScriptBlock** parameter.</span></span>

## <span data-ttu-id="a86eb-513">OBSERVAÇÕES</span><span class="sxs-lookup"><span data-stu-id="a86eb-513">NOTES</span></span>

<span data-ttu-id="a86eb-514">No Windows Vista e versões posteriores do sistema operacional Windows, para usar o parâmetro **ComputerName** do `Invoke-Command` para executar um comando no computador local, você deve executar o PowerShell usando a opção **Executar como administrador** .</span><span class="sxs-lookup"><span data-stu-id="a86eb-514">On Windows Vista, and later versions of the Windows operating system, to use the **ComputerName** parameter of `Invoke-Command` to run a command on the local computer, you must run PowerShell using the **Run as administrator** option.</span></span>

<span data-ttu-id="a86eb-515">Quando você executa comandos em vários computadores, o PowerShell se conecta aos computadores na ordem em que aparecem na lista.</span><span class="sxs-lookup"><span data-stu-id="a86eb-515">When you run commands on multiple computers, PowerShell connects to the computers in the order in which they appear in the list.</span></span> <span data-ttu-id="a86eb-516">No entanto, a saída do comando é exibida na ordem em que ela é recebida dos computadores remotos, o que pode ser diferente.</span><span class="sxs-lookup"><span data-stu-id="a86eb-516">However, the command output is displayed in the order that it's received from the remote computers, which might be different.</span></span>

<span data-ttu-id="a86eb-517">Os erros resultantes do comando `Invoke-Command` executado são incluídos nos resultados do comando.</span><span class="sxs-lookup"><span data-stu-id="a86eb-517">Errors that result from the command that `Invoke-Command` runs are included in the command results.</span></span>
<span data-ttu-id="a86eb-518">Erros que poderiam ser erros de finalização em um comando local são tratados como erros de não finalização em um comando remoto.</span><span class="sxs-lookup"><span data-stu-id="a86eb-518">Errors that would be terminating errors in a local command are treated as non-terminating errors in a remote command.</span></span> <span data-ttu-id="a86eb-519">Essa estratégia garante que os erros de encerramento em um computador não fechem o comando em todos os computadores nos quais ele é executado.</span><span class="sxs-lookup"><span data-stu-id="a86eb-519">This strategy makes sure that terminating errors on one computer don't close the command on all computers on which it's run.</span></span> <span data-ttu-id="a86eb-520">Essa prática é utilizada mesmo quando um comando remoto é executado em um único computador.</span><span class="sxs-lookup"><span data-stu-id="a86eb-520">This practice is used even when a remote command is run on a single computer.</span></span>

<span data-ttu-id="a86eb-521">Se o computador remoto não estiver em um domínio no qual o computador local confia, talvez o computador não consiga autenticar as credenciais do usuário.</span><span class="sxs-lookup"><span data-stu-id="a86eb-521">If the remote computer isn't in a domain that the local computer trusts, the computer might not be able to authenticate the user's credentials.</span></span> <span data-ttu-id="a86eb-522">Para adicionar o computador remoto à lista de hosts confiáveis no WS-Management, use o seguinte comando no `WSMAN` provedor, em que `<Remote-Computer-Name>` é o nome do computador remoto:</span><span class="sxs-lookup"><span data-stu-id="a86eb-522">To add the remote computer to the list of trusted hosts in WS-Management, use the following command in the `WSMAN` provider, where `<Remote-Computer-Name>` is the name of the remote computer:</span></span>

`Set-Item -Path WSMan:\Localhost\Client\TrustedHosts -Value \<Remote-Computer-Name\>`

<span data-ttu-id="a86eb-523">Quando você desconecta uma **PSSession** usando o parâmetro **InDisconnectedSession** , o estado da sessão é **desconectado** e a disponibilidade é **nenhuma** .</span><span class="sxs-lookup"><span data-stu-id="a86eb-523">When you disconnect a **PSSession** using the **InDisconnectedSession** parameter, the session state is **Disconnected** and the availability is **None** .</span></span> <span data-ttu-id="a86eb-524">O valor da propriedade **State** é relativo a sessão atual.</span><span class="sxs-lookup"><span data-stu-id="a86eb-524">The value of the **State** property is relative to the current session.</span></span> <span data-ttu-id="a86eb-525">Um valor de **desconectado** significa que a **PSSession** não está conectada à sessão atual.</span><span class="sxs-lookup"><span data-stu-id="a86eb-525">A value of **Disconnected** means that the **PSSession** isn't connected to the current session.</span></span> <span data-ttu-id="a86eb-526">No entanto, isso não significa que a **PSSession** seja desconectada de todas as sessões.</span><span class="sxs-lookup"><span data-stu-id="a86eb-526">However, it doesn't mean that the **PSSession** is disconnected from all sessions.</span></span> <span data-ttu-id="a86eb-527">Ela pode ser conectada a uma sessão diferente.</span><span class="sxs-lookup"><span data-stu-id="a86eb-527">It might be connected to a different session.</span></span> <span data-ttu-id="a86eb-528">Para determinar se é possível conectar-se ou reconectar-se à sessão, utilize a propriedade **Availability** .</span><span class="sxs-lookup"><span data-stu-id="a86eb-528">To determine whether you can connect or reconnect to the session, use the **Availability** property.</span></span>

<span data-ttu-id="a86eb-529">Um valor **Availability** de **None** indica que é possível conectar-se à sessão.</span><span class="sxs-lookup"><span data-stu-id="a86eb-529">An **Availability** value of **None** indicates that you can connect to the session.</span></span> <span data-ttu-id="a86eb-530">Um valor de **ocupado** indica que você não pode se conectar à **PSSession** porque ela está conectada a outra sessão.</span><span class="sxs-lookup"><span data-stu-id="a86eb-530">A value of **Busy** indicates that you can't connect to the **PSSession** because it's connected to another session.</span></span> <span data-ttu-id="a86eb-531">Para obter mais informações sobre os valores da propriedade **State** de sessões, consulte [RunspaceState](/dotnet/api/system.management.automation.runspaces.runspacestate).</span><span class="sxs-lookup"><span data-stu-id="a86eb-531">For more information about the values of the **State** property of sessions, see [RunspaceState](/dotnet/api/system.management.automation.runspaces.runspacestate).</span></span> <span data-ttu-id="a86eb-532">Para obter mais informações sobre os valores da propriedade de sessões de **disponibilidade** , consulte [RunspaceAvailability](/dotnet/api/system.management.automation.runspaces.runspaceavailability).</span><span class="sxs-lookup"><span data-stu-id="a86eb-532">For more information about the values of the **Availability** property of sessions, see [RunspaceAvailability](/dotnet/api/system.management.automation.runspaces.runspaceavailability).</span></span>

## <span data-ttu-id="a86eb-533">LINKS RELACIONADOS</span><span class="sxs-lookup"><span data-stu-id="a86eb-533">RELATED LINKS</span></span>

[<span data-ttu-id="a86eb-534">about_PSSessions</span><span class="sxs-lookup"><span data-stu-id="a86eb-534">about_PSSessions</span></span>](./About/about_PSSessions.md)

[<span data-ttu-id="a86eb-535">about_Remote</span><span class="sxs-lookup"><span data-stu-id="a86eb-535">about_Remote</span></span>](./About/about_Remote.md)

[<span data-ttu-id="a86eb-536">about_Remote_Disconnected_Sessions</span><span class="sxs-lookup"><span data-stu-id="a86eb-536">about_Remote_Disconnected_Sessions</span></span>](./About/about_Remote_Disconnected_Sessions.md)

[<span data-ttu-id="a86eb-537">about_Remote_Troubleshooting</span><span class="sxs-lookup"><span data-stu-id="a86eb-537">about_Remote_Troubleshooting</span></span>](./About/about_remote_troubleshooting.md)

[<span data-ttu-id="a86eb-538">about_Remote_Variables</span><span class="sxs-lookup"><span data-stu-id="a86eb-538">about_Remote_Variables</span></span>](./About/about_Remote_Variables.md)

[<span data-ttu-id="a86eb-539">about_Scopes</span><span class="sxs-lookup"><span data-stu-id="a86eb-539">about_Scopes</span></span>](./About/about_scopes.md)

[<span data-ttu-id="a86eb-540">Enter-PSSession</span><span class="sxs-lookup"><span data-stu-id="a86eb-540">Enter-PSSession</span></span>](Enter-PSSession.md)

[<span data-ttu-id="a86eb-541">Exit-PSSession</span><span class="sxs-lookup"><span data-stu-id="a86eb-541">Exit-PSSession</span></span>](Exit-PSSession.md)

[<span data-ttu-id="a86eb-542">Get-PSSession</span><span class="sxs-lookup"><span data-stu-id="a86eb-542">Get-PSSession</span></span>](Get-PSSession.md)

[<span data-ttu-id="a86eb-543">Invoke-Item</span><span class="sxs-lookup"><span data-stu-id="a86eb-543">Invoke-Item</span></span>](../Microsoft.PowerShell.Management/Invoke-Item.md)

[<span data-ttu-id="a86eb-544">New-PSSession</span><span class="sxs-lookup"><span data-stu-id="a86eb-544">New-PSSession</span></span>](New-PSSession.md)

[<span data-ttu-id="a86eb-545">Remove-PSSession</span><span class="sxs-lookup"><span data-stu-id="a86eb-545">Remove-PSSession</span></span>](Remove-PSSession.md)

[<span data-ttu-id="a86eb-546">Provedor WSMan</span><span class="sxs-lookup"><span data-stu-id="a86eb-546">WSMan Provider</span></span>](../Microsoft.WsMan.Management/About/about_WSMan_Provider.md)
