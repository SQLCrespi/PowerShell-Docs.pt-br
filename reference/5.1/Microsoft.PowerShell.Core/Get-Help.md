...
O parâmetro de **janela** é compatível com os tópicos de ajuda para comandos (cmdlets, funções, comandos CIM, fluxos de trabalho, scripts) e conceitos **sobre** artigos. Ele não fornece ajuda sobre o provedor .
