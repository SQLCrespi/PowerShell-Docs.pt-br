...
## DESCRIPTION
O cmdlet **Wait-Job** aguarda a conclusão dos trabalhos em segundo plano do Windows PowerShell antes de exibir o prompt de comando.
...
Para obter mais informações sobre o modificador de escopo de **uso** , consulte about_Remote_Variables ( https://go.microsoft.com/fwlink/?LinkID=252653) .
