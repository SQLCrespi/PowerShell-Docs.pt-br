...
## <a name="update-help-in-the-powershell-ise"></a>Atualizar a ajuda no ISE do PowerShell

Você também pode atualizar a ajuda usando o item de **ajuda atualizar o PowerShell** no menu ajuda no ISE (ambiente de script integrado) do PowerShell.

O item de **ajuda atualizar o PowerShell** executa um `Update-Help` comando sem parâmetros.
