...
> A solução alternativa é usar *modificadores de modo* em sua expressão regular.
> Você pode ler mais sobre modificadores de modo em [Opções de expressão regular](/dotnet/standard/base-types/regular-expression-options)
