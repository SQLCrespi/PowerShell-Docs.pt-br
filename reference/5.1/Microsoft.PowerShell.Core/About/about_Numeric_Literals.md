...
- Se o sufixo de tipo for `u` e o valor puder ser representado pelo tipo `[int]` , seu tipo será `[int]` .
- Se o sufixo de tipo for `u` e o valor puder ser representado pelo tipo `[long]` , seu tipo será `[long]` .
