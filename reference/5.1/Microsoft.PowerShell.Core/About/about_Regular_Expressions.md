...
O exemplo a seguir armazena o **SuccessAudit** mais recente do log de segurança do Windows. A expressão regular fornecida extrai o nome de usuário e o domínio da mensagem e os armazena sob as chaves: **N** para nome e **D** para o domínio.
