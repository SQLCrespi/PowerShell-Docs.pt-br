...
---
# <a name="about-logging"></a>Sobre registro em log
...
Os logs do PowerShell podem ser exibidos usando o Windows Visualizador de Eventos. O log de eventos está localizado no grupo logs de aplicativos e serviços e é nomeado `Microsoft-Windows-PowerShell` . O provedor de ETW associado `GUID` é `{A0C1853B-5C40-4B15-8766-3CF1C58F985A}` .

Quando o log de bloco de script estiver habilitado, o PowerShell registrará os seguintes eventos no `Microsoft-Windows-PowerShell/Operational` log:
