...
- [ConvertFrom-String](xref:Microsoft.PowerShell.Utility.ConvertFrom-String): criada na parte superior de [FlashExtract](https://www.microsoft.com/research/publication/flashextract-framework-data-extraction-examples), `ConvertFrom-String` cria objetos personalizados de dados de cadeia de caracteres estruturados.
