...
Define os arquivos a serem excluídos do módulo publicado. O suporte a parâmetro de **exclusão** é adicionado na versão do **PowershellGet** 2.0.0.
...
Remove comandos e recursos de serem incluídos como marcas. Ignora a adição automática de marcas a um módulo. O suporte ao parâmetro **SkipAutomaticTags** é adicionado na versão do **PowerShellGet** 2.0.0
