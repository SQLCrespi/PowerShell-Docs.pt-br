...
Esse cmdlet é executado no PowerShell 5,0 ou versões posteriores do Windows PowerShell, no Windows 7 ou no Windows 2008 R2 e versões posteriores do Windows.
