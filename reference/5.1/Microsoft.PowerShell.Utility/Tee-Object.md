...
`Tee-Object` usa a codificação "Unicode" (UTF-16LE) quando grava em arquivos. Se você precisar de uma codificação diferente, use o `Out-File` cmdlet com o parâmetro **Encoding** .
