...
Este exemplo usa o `Get-FileHash` cmdlet para calcular o valor de hash para o `Powershell.exe` arquivo.
O algoritmo de hash utilizado é o padrão, SHA256. A saída é canalizada para o `Format-List` cmdlet para formatar a saída como uma lista.
