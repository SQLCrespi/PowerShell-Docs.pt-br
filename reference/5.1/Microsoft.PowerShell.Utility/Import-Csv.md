...
`Import-Csv` usa a BOM (marca de ordem de byte) para detectar o formato de codificação do arquivo. Se o arquivo não tiver uma BOM, ele assumirá que a codificação é UTF8.
