...
### Programas: PackageByInputObject
...
Especifica um ou mais argumentos adicionais para instalação.
...
Indica que esse cmdlet inclui componentes do sistema nos resultados.
...
Indica que esse cmdlet inclui o Windows Installer nos resultados.
