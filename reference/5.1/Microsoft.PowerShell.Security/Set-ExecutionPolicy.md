...
- **Irrestrito** . Carrega todos os arquivos de configuração e executa todos os scripts. Se executar um script não assinado baixado da Internet, será solicitado, antes da execução, que você tenha permissão.
