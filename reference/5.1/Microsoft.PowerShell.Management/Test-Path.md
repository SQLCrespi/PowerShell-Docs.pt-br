...
Quando uma cadeia de caracteres de espaço em branco é fornecida para o `-Path` parâmetro, ela retorna **true** . Quando uma cadeia de caracteres vazia é fornecida, `Test-Path` o retorna um erro. O exemplo a seguir mostra o espaço em branco e a cadeia de caracteres vazia.
