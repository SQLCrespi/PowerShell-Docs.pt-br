...
> [!NOTE]
> Quando você cria um arquivo usando esse método, o arquivo resultante é codificado como UTF-8 sem uma BOM (marca de ordem de byte).
...
### Exemplo 6: usar o parâmetro-Force para tentar recriar pastas
...
### Exemplo 7: usar o parâmetro-Force para substituir os arquivos existentes
