...
## DESCRIPTION
O cmdlet **Disable-LocalUser** desabilita as contas de usuário locais.
Quando uma conta de usuário é desabilitada, o usuário não pode fazer logon.
Quando uma conta de usuário é habilitada, o usuário pode fazer logon.
...
### Exemplo 1: desabilitar uma conta especificando um nome

```
PS C:\> Disable-LocalUser -Name "Admin02"
```

Este comando desabilita a conta de usuário chamada Admin02.

### Exemplo 2: desabilitar uma conta usando o pipeline

```
PS C:\> Get-LocalUser Guest | Disable-LocalUser
```

Esse comando obtém a conta de convidado interna usando **Get-LocalUser** e, em seguida, a passa para o cmdlet atual usando o operador de pipeline.
Esse cmdlet desabilita essa conta.

## PARAMETERS

### -InputObject
Especifica uma matriz de contas de usuário que este cmdlet desabilita.
...
### -Name
Especifica uma matriz de nomes das contas de usuário que esse cmdlet desabilita.
