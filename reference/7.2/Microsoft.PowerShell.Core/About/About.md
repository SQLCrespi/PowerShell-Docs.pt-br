...
Descreve como usar os recursos experimentais do PowerShell.
...
Explica como usar a ferramenta de linha de comando pwsh. Exibe a sintaxe e descreve as opções de linha de comando. pwsh inicia uma sessão do PowerShell.
...
Descreve a telemetria coletada no PowerShell.
