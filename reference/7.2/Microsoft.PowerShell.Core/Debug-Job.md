...
Para obter a *InstanceId* de um trabalho, execute o cmdlet **Get-Job** , canalizando os resultados em um cmdlet **Format-** _, conforme mostrado no exemplo a seguir:
...
A maneira mais simples de usar esse parâmetro é salvar os resultados de um comando _ *Get-Job** que retorna o trabalho em execução que você deseja depurar em uma variável e, em seguida, especificar a variável como o valor desse parâmetro.
...
{{Descrição de BreakAll de preenchimento}}
