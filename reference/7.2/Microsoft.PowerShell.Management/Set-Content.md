...
Esse parâmetro foi introduzido no PowerShell 3,0. A partir do PowerShell 7,2, `Set-Content` o pode definir o conteúdo de fluxos de dados alternativos de diretórios, bem como arquivos.
