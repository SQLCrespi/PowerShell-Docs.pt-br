...
Este parâmetro foi introduzido no Windows PowerShell 3.0. A partir do Windows PowerShell 7,2, o `Remove-Item` pode remover fluxos de dados alternativos de diretórios, bem como arquivos.
...
Solicita sua confirmação antes de executar o cmdlet. Para obter mais informações, confira os seguintes artigos:
