...
Este parâmetro foi introduzido no Windows PowerShell 3.0. No PowerShell 7,2, Get-Content pode recuperar o conteúdo de fluxos de dados alternativos de diretórios, bem como arquivos.
