...
Esse parâmetro foi introduzido no PowerShell 3,0.  A partir do PowerShell 7,2, o `Add-Content` pode direcionar fluxos de dados alternativos em arquivos e diretórios.
