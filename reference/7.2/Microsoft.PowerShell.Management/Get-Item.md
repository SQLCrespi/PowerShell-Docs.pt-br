...
Esse parâmetro foi introduzido no PowerShell 3,0.  A partir do PowerShell 7,2, o `Get-Item` pode obter fluxos de dados alternativos de diretórios, bem como arquivos.
