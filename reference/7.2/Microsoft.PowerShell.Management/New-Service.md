...
### Exemplo 4: definir o SecurityDescriptor de um serviço ao criar.
...
O **SecurityDescriptor** é armazenado na `$SDDLToSet` variável. O parâmetro **SecurityDescriptorSddl** usa `$SDDL` para definir o **SecurityDescriptor** do novo serviço.
