...
A partir do PowerShell 7,2, `ConvertTo-Json` o emitirá um aviso se a profundidade do objeto de entrada exceder a profundidade especificada para o comando. Isso impede a perda de dados indesejados durante a conversão de objetos.
...
Especifica quantos níveis de objetos contidos estão incluídos na representação JSON. O valor padrão é 2. A partir do PowerShell 7,2, `ConvertTo-Json` emitirá um aviso se o número de níveis em um objeto de entrada exceder esse número.
