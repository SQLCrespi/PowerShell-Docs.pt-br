...
ms.locfileid: "62085058"
---
# <a name="powershell-script-discovery-install-and-management-with-powershellget"></a><span data-ttu-id="a2ffc-102">Descoberta, instalação e gerenciamento de script do PowerShell com o PowerShellGet</span><span class="sxs-lookup"><span data-stu-id="a2ffc-102">PowerShell Script Discovery, Install and Management with PowerShellGet</span></span>

<span data-ttu-id="a2ffc-103">O recurso de Compartilhamento de script do PowerShell foi adicionado ao PowerShellGet na versão WMF 5.0 RTM.</span><span class="sxs-lookup"><span data-stu-id="a2ffc-103">PowerShell Script sharing feature got added to the PowerShellGet in the WMF 5.0 RTM release.</span></span>
<span data-ttu-id="a2ffc-104">Os novos cmdlets a seguir foram adicionados ao módulo PowerShellGet para dar suporte aos Scripts do PowerShell.</span><span class="sxs-lookup"><span data-stu-id="a2ffc-104">The following new cmdlets are added to the PowerShellGet module for supporting the PowerShell Scripts.</span></span>
```powershell
...
<span data-ttu-id="a2ffc-105">Sintaxe dos Cmdlets de compartilhamento de script:</span><span class="sxs-lookup"><span data-stu-id="a2ffc-105">Syntax of script sharing Cmdlets:</span></span>
```powershell
